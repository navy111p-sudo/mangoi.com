...
<section class=\"course_area\">
	<!--ul class=\"edu_tabs\">
		<li><a href=\"#\" class=\"active\"><span class=\"bar\"></span>레벨구성</a></li>
	...
	<section class=\"level_wrap_2\">
		<div class=\"level_area_2\">
			<h3 class=\"level_caption_2\">나는 초보라서 원어민과 수업이 힘들다??</h3>
			<div class=\"level_text\">
				초보이기 때문에 더더욱 <div class=\"break\">원어민이 필요합니다.</div>
                <div>머뭇거리지 마시고 지금 바로<div class=\"break\">레벨 테스트 신청하세요.</div></div>
			</div>
			<a href=\"leveltest_register_intro.html\" class=\"btn_gradient_pink\" >레벨테스트 신청하기</a>
		</div>
	</section>
