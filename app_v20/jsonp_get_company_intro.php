...
$GetHTML = "
	...
	<section class=\"company_wrap\">
        <h2 class=\"sub_title_company\">왜 <img src=\"".$ServerPath."images/logo_text_mangoi.png\" alt=\"망고아이\"> 화상영어인가?</h2>
		<div class=\"company_area\">
			<table class=\"company_table\">
				<tr>
					<td>
						<h2 class=\"caption_company\">Vision</h2>
						<h4>글로벌 커뮤니케이션 인재 양성</h4>
						...
						<h4>영어, 중국어, 일본어, 한국어</h4>
						<ul class=\"company_language\">
							<li>중국, 일본, 한국에 Triangle Languages Service Provider</li>
							<li>랭귀지 서비스를 통한 Communication enabler 포지셔닝</li>
						</ul>
					</td>
	...
	<section class=\"company_manager_wrap\">
		<div class=\"company_manager_area\">
			<h2 class=\"caption_sub\"><span class=\"normal\">경영진</span></h2>
					...
					<table class=\"company_manager_table\">
						<tr>
							<th class=\"company_manager_left\">
								...
								<h3>정우영 <span class=\"break\">대표이사</span></h3>
							</th>
							<td>
								<ol class=\"company_manager_right\">
									...
									<li>성균관대 겸임교수 (현)</li>
									<li>성균관대 경영학 박사</li>
									<li>New York University 경제학 전공</li>
								</ol>
							</td>
						</tr>
					</table>
					...
					<table class=\"company_manager_table\">
						<tr>
							<th class=\"company_manager_left\">
								...
								<h3>이병엽 <span class=\"break\">이사</span></h3>
							</th>
							<td>
								<ol class=\"company_manager_right\">
									<li>前 외대어학원 본원 원장</li>
									<li>Brighton 어학원 원장</li>
									<li>박학천 강남 직영원 원장</li>
									<li>톡스톡스 화상영어 본부장</li>
									<li>샘과나무 화상영어 총괄 본부장 역임</li>
								</ol>
							</td>
						</tr>
					</table>
					...
					<table class=\"company_manager_table\">
						<tr>
							<th class=\"company_manager_left\">
								...
								<h3>장지웅 <span class=\"break\">기획실장</span></h3>
							</th>
							<td>
								<ol class=\"company_manager_right\">
									<li>에듀비전 상담실장</li>
	...
	<section class=\"company_mean_wrap\">
		<div class=\"company_mean_area\">
			<h2 class=\"caption_sub\"><span class=\"normal\">망고아이 설립이념</span></h2>
			<h3 class=\"caption_mean\">설립이념</h3>
			<div class=\"company_mean_text_1\">
				망고아이는 우리나라에 올바른 언어교육을 정착시키고자 설립되었습니다.<br>
				현재 한국의 주입식, 입시위주, 암기식 교육에서 벗어나 통합적인 교육을 통해 진정한
				영어교육의 정도를 제시합니다. 교사, 교재, 교수법의 3요소가 적절하게 적용되어
				수업 할 수 있도록 끊임없이 연구하고, 학생이 언어를 즐겁게 배울 수 있는 것을
				목표로 합니다.
			</div>
			<h3 class=\"caption_mean\">교육목표</h3>
			<ul class=\"company_mean_text_2\">
				<li><b>01.</b> 학습의 좋은 결과를 위하여 과정에 더 집중하여 교육한다.</li>
                <li><b>02.</b> 성취도와 흥미도를 모두 고려하여 교육한다.</li>
                <li><b>03.</b> 획일화된 교수법에서 벗어나 학생의 흥미, 적성, 가치관을 고려하여 교육한다.</li>
                <li><b>04.</b> 학교뿐만 아니라 회사나 사회에서 평생 사용할 수 있는 실용적인 교육을 추구한다.</li>
                <li><b>05.</b> 인성과 사회성 그리고 자유와 평등 같은 인간의 보편적 가치를 추구하는 교육을 한다.</li>
                <li><b>06.</b> 단기적인 성적 향상과 입시 진학 그리고 취업에만 국한 되지 않고 평생 교육을 목표로 지속적으로 성장하고 발전하는 실용적인 교육을 추구한다.</li>
                <li><b>07.</b> 인류와 사회에 공헌 할 수 있는 글로벌 인재를 배출하기 위해 교육한다.</li>
                <li><b>08.</b> 인성과 실력을 갖춘 우수한 강사진과 체계적인 관리시스템, 끊임없는 교재 연구로 교육의 질을 향상 시키는데 노력한다.</li>
            </ul>
		</div>
	</section>
	...
	<section class=\"company_history_wrap\">
		<div class=\"company_history_area\">
			<h2 class=\"caption_sub\"><span class=\"normal\">연혁</span></h2>
			<ul class=\"company_history_list\">
				<li>
					<div class=\"year right\"><h3 class=\"caption\">2019.07</h3>망고아이 Application 제작 설치</div>
				...
				<li>
					<div class=\"blank\"></div>
					<div class=\"circle\"><div class=\"line\"></div><img src=\"".$ServerPath."images/bullet_history.png\" class=\"bullet\"></div>
					<div class=\"year left\"><h3 class=\"caption\">2017.12</h3>망고아이 예습복습 비디오 및 퀴즈 제작 탑재</div>
				</li>
				<li>
					<div class=\"year right\"><h3 class=\"caption\">2014.06</h3>중국 천진 법인설립</div>
					<div class=\"circle\"><div class=\"line\"></div><img src=\"".$ServerPath."images/bullet_history.png\" class=\"bullet\"></div>
					<div class=\"blank\"></div>
				</li>
				<li>
					<div class=\"blank\"></div>
					<div class=\"circle\"><div class=\"line\"></div><img src=\"".$ServerPath."images/bullet_history.png\" class=\"bullet\"></div>
					<div class=\"year left\"><h3 class=\"caption\">2012.05</h3>홈페이지, 솔루션, 학생관리체계(LMS) Version-Up</div>
				</li>
				<li>
					<div class=\"year right\"><h3 class=\"caption\">2011.06</h3>화상영어 콜센타 Ortigas Center로 이전</div>
					<div class=\"circle\"><div class=\"line\"></div><img src=\"".$ServerPath."images/bullet_history.png\" class=\"bullet\"></div>
					<div class=\"blank\"></div>
				</li>
				<li>
					<div class=\"blank\"></div>
					<div class=\"circle\"><div class=\"line\"></div><img src=\"".$ServerPath."images/bullet_history.png\" class=\"bullet\"></div>
					<div class=\"year left\"><h3 class=\"caption\">2010.12</h3>전국 SLP 어학원에 화상 수업 실시 (약 1,300 회원)</div>
				</li>
				<li>
					<div class=\"year right\"><h3 class=\"caption\">2009.12</h3>화상영어 Mangoi 서비스 개시</div>
					<div class=\"circle\"><div class=\"line\"></div><img src=\"".$ServerPath."images/bullet_history.png\" class=\"bullet\"></div>
					<div class=\"blank\"></div>
				</li>
				<li>
					<div class=\"blank\"></div>
					<div class=\"circle\"><div class=\"line\"></div><img src=\"".$ServerPath."images/bullet_history.png\" class=\"bullet\"></div>
					<div class=\"year left\"><h3 class=\"caption\">2007.09</h3>실크로드 중국어 어학원 개원</div>
				</li>
				<li>
					<div class=\"year right\"><h3 class=\"caption\">2006.03</h3>(주)에듀비전 법인설립</div>
					<div class=\"circle\"><div class=\"line\"></div><img src=\"".$ServerPath."images/bullet_history.png\" class=\"bullet\"></div>
					<div class=\"blank\"></div>
				</li>
				<li>
					<div class=\"blank\"></div>
					<div class=\"circle\"><div class=\"line\"></div><img src=\"".$ServerPath."images/bullet_history.png\" class=\"bullet\"></div>
					<div class=\"year left\"><h3 class=\"caption\">2001.09</h3>안산SLP 영어 어학원 개원</div>
				</li>
			</ul>
		</div>
	</section>
	...
	<section class=\"company_organization_wrap\">
		<div class=\"company_organization_area\">
			<h2 class=\"caption_sub\"><span class=\"normal\">조직도</span></h2>
	...
	<section class=\"company_main_wrap\">
		<div class=\"company_main_area\">
			<h2 class=\"caption_sub\">주요사업 <span class=\"normal\">Categories</span></h2>
	...
	<section class=\"company_csr_wrap\">
		<div class=\"company_csr_area\">
			...
			<div class=\"company_csr_text\">
				Mangoi 필리핀 민다나오 지역사회를 돕고자 다양한 봉사활동과  기부 행사를 진행하고 있습니다.
