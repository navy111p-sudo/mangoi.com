            ...
            <div class="page no-toolbar" data-page="intro_mypage">
                <div class="page-content navbar-fix">
					<section class="member_area">
						...
						<h3 class="member_join_caption">추가정보 입력<span><b class="member_red">★</b> 표시는 필수 입력사항입니다.</span></h3>
						...
						<h3 class="member_join_caption">수업정보, 상담정보, 기타 부가정보</h3>
