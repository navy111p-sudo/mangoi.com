...
<section class=\"app_class_wrap\">
	<h3 class=\"caption_center\">수강안내</h3>
	...
	<ul class=\"class_guide_list one\">
		<li>
			수업연기 신청은 수업시작 30분전까지 My Page (나의 공부방)에 수업연기 버튼을 눌러서 원하는 일시를 눌러 자동으로 신청하시기 바랍니다.<br>
            연기 횟수는 수강 횟수의 1/2회까지 가능합니다.<br>
            (예: 주1회 최대 월 2회, 주 3회 시 최대 월 6회)
		</li>
	</ul>

	<ul class=\"class_guide_list two\">
		<li>수업연기요청은 수업시작 30분전에까지 교사의 공강 여부에 따라 가능합니다.</li>
		<li>수강기간은 일수가 아닌 횟수로 정해집니다. <b class=\"break\">(주5회 수업 - 20회)</b></li>
	...
	<h3 class=\"caption_center\">수강규정</h3>
	<div class=\"class_guide_box center\">
		<h3>맞춤식 고정 수업 안내</h3>
		강사 한분과 매일 또는 주3회, 주2회 정해진 시간에 규칙적으로 꾸준히 수업하려는 목표를 가진분을 위한 시스템입니다.
	</div>

	<h4 class=\"class_rule_caption\">고정 수업 가이드</h4>
	<ul class=\"class_rule_list\">
		<li><span>01.</span>수강료 결제를 완료하시면 24시간 내에 학습매니저가 카카오톡으로 수강 방법에 대해 안내해 드립니다.</li>
		<li><span>02.</span>수업스케줄이 잡히면 바로 수강하실 수 있으며, 교재 구입전이라도 온라인상의 샘플교재를 이용하여 수강하실 수 있습니다.</li>
		<li><span>03.</span>수강기간은 횟수로 정해집니다. (1개월 수업의 경우 주5회는 20회 수업, 주3회 수업은 12회 수업, 주2회 수업은 8회 수업)</li>
	</ul>

	<h4 class=\"class_rule_caption\">일일 수업 연기</h4>
	<ul class=\"class_rule_list\">
		<li><span>01.</span>상황이 불가피하여 수업을 받을 수 없는 경우에 수업을 연기할 수 있습니다. </li>
		<li><span>02.</span>수업연기 횟수는 진도와 향상을 위해서 전체 월 수업 횟수의 ½만 가능합니다.</li>
		<li><span>03.</span>수업연기는 마이 페이지 (My) > 공부방 입장 > 수업 연기요청으로 들어가시면 됩니다. 당일 수업의 연기는 교사의 수업상황에 따라서 수업 시작 30분 전까지 가능합니다.</li>
	</ul>

	<h4 class=\"class_rule_caption\">수업 시간 변경</h4>
	<ul class=\"class_rule_list\">
		<li><span>01.</span>수업시간을 변경하고자 하는 경우에는 어플에서 연기신청을 눌러서 교사 또는 수업 시간 둘 중 선택가능합니다.</li>
		<li><span>02.</span>수업시간을 변경하시면 담당강사가 변경될 수 있으며, 변경신청 시 유념하시기 바랍니다.</li>
		<li><span>03.</span>수업시간 변경은 전체 월 수업시간의 ½회 가능합니다.</li>
	</ul>

	<h4 class=\"class_rule_caption\">담당 강사 변경</h4>
	<ul class=\"class_rule_list\">
	...
	<h4 class=\"class_rule_caption\">결석 처리 안내</h4>
	<ul class=\"class_rule_list\">
		<li><span>01.</span>전화영어, 휴대전화영어 수업은 총3회 전화하여 응답이 없을 경우 결석처리 됩니다.</li>
		<li><span>02.</span>수강생의 과실로 인한 결석은 별도의 보강이 제공되지 않습니다.</li>
		<li>
			<span>03.</span>수강생의 사정으로 인해 수업시작이 지연된 경우에는 수업시간을 채우지 못했다 할지라도 예정된 종료시간에 수업이 종료됩니다.<br>
			(뒤이어 예약된 학생의 수업에 지장을 끼칠 우려가 있으므로 불가피함)
		</li>
	</ul>
</section>
