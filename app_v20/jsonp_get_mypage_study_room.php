...
$PageMyPageRoomHTML .= "		<li style=\"width:48%;\"><a href=\"#\" class=\"active\"><span class=\"bar\"></span>나의 공부방</a></li>";
$PageMyPageRoomHTML .= "		<li style=\"width:48%;\"><a href=\"mypage_study_history.html\" class=\"item-link item-content\"><span class=\"bar\"></span>학습 이력</a></li>";
...
$PageMyPageRoomHTML .= " 
		<div style=\"display:inline-block;width:49%;text-align:left;\">
			<li><a href=\"#\" onclick=\"OpenLessonVideos();\" class=\"color_review_book\" style=\"padding:2px 10px;\">전체레슨비디오</a></li>
		</div>
		<div style=\"display:inline-block;width:49%;text-align:right;\">
			<li><a href=\"report_monthly_list.html\" class=\"color_review_book\" style=\"padding:2px 10px;background-color:#005E8A;\">정기평가보고서</a></li>
		</div>
";
...
if ($SelectMonth == date("m") && $SelectYear == date("Y")){//현재달
	if ($GetAllList==""){
		...
		$PageMyPageRoomHTML .= "<div style=\"width:100%;height:30px;text-align:center;background-color:#cccccc;color:#ffffff;border-radius:10px;margin-top:20px;line-height:30px;\" onclick=\"GetPageMyPageRoom('', '', '1')\">지난수업보기</div> ";
	}
}
...
if ($LocalLinkMemberID==10722 || $LocalLinkMemberID==10723 || $LocalLinkMemberID==13907 ){ 
	...
	$PageMyPageRoomHTML .= "		<li style=\"width:100%;\"><a href=\"#\" class=\"color_classin\" onclick=\"OpenClassSh_Sample('-1', '37_20101101_20_10', 0, '".$memberLoginID."', '".$memberLoginID."');\">수업입장</a></li>";
	...
	$PageMyPageRoomHTML .= "		<li id=\"BtnResetDate\" style=\"width:100%;\"><a href=\"#\" onclick=\"OpenResetDateForm_Sample(-1, 1);\" class=\"color_postpone\">수업연기요청</a></li>";
...
for ($iiii=$SelectYearMonthStartDay;$iiii<=$SelectYearMonthEndDay;$iiii++){
	...
	if ($TotalRowCount>0){
		...
		while($Row = $Stmt->fetch()) {
			...
			$PageMyPageRoomHTML .= "			<div class=\"schedule_english\">";
			$PageMyPageRoomHTML .= "				<div class=\"schedule_english_left\">".$StrClassProductID."</div>";
			$PageMyPageRoomHTML .= "				<div class=\"schedule_english_right\">수업</div>";
			$PageMyPageRoomHTML .= "			</div>";
			$PageMyPageRoomHTML .= "		</div>";
			...
			if ($TodayIsHoliday==1 && $ClassState!=2){
				...
				$PageMyPageRoomHTML .= "<li style=\"width:100%;\"><a href=\"#\" class=\"color_classin\"  style=\"background-color:#888888;\">휴무일 - 연기처리(대상)</a></li>";

			}else{
				//=========================== DD ===========================
				if ($ClassAttendState==4 || $ClassAttendState==5 || $ClassAttendState==6 || $ClassAttendState==7 || $ClassAttendState==8){//연기, 취소, 교사변경
					
					$PageMyPageRoomHTML .= "<li style=\"width:100%;\"><a href=\"#\" class=\"color_classin\"  style=\"background-color:#888888;\">".$StrClassAttendState."</a></li>";
				...
				//=========================== DD ===========================
					...
					if ($ClassState==0){//등록완료 0:미등록 전 1:등록완료 2:수업완료
						...
						if ($CurrentDateType==0 || $CurrentDateType>0){
							$PageMyPageRoomHTML .= "<li style=\"width:100%;\"><a href=\"#\" class=\"color_classin\" style=\"background-color:#F3A39E;\">수업준비중</a></li>";
						}else{
							$PageMyPageRoomHTML .= "<li style=\"width:100%;\"><a href=\"#\" class=\"color_classin\" style=\"background-color:#888888;\">경과된수업</a></li>";
						}

					}else{//등록완료 0:미등록 전 1:등록완료 2:수업완료
						
						if ($ClassState==2){//등록완료 0:미등록 전 1:등록완료 2:수업완료
							$PageMyPageRoomHTML .= "<li style=\"width:100%;\"><a href=\"#\" class=\"color_classin\" style=\"background-color:#888888;\">종료된수업</a></li>";
						}else{
							if ($CurrentDateType==0 || $CurrentDateType>0){

								if ($ClassLinkType==1){
									$PageMyPageRoomHTML .= "<li style=\"width:100%;\"><a href=\"#\" class=\"color_classin\" onclick=\"OpenClassShPreSet('".$ClassID."', '".$CommonShClassCode."', 0, '".$MemberName."', '".$MemberLoginID."');\">수업입장</a></li>";
								}else{
									$PageMyPageRoomHTML .= "<li style=\"width:100%;\"><a href=\"#\" class=\"color_classin\" onclick=\"OpenClassCiCheckPreSet(".$ClassID.", '".$CommonCiTelephoneTeacher."', '".$CommonCiTelephoneStudent."', 1, '".$MemberName."', 'MangoiClass_".$ClassID."');\">수업입장</a></li>";
								}
						...
						if ($ClassProductID!=2){
							$PageMyPageRoomHTML .= "<li style=\"width:45%;\"><a href=\"#\" onclick=\"".$LinkVideo."\" class=\"color_lesson_video\">레슨비디오 A</a></li>";
							$PageMyPageRoomHTML .= "<li style=\"width:45%;\"><a href=\"#\" onclick=\"".$LinkVideo2."\" class=\"color_lesson_video\">레슨비디오 B</a></li>";
							$PageMyPageRoomHTML .= "<li style=\"width:45%;\"><a href=\"#\" onclick=\"".$LinkScan."\" class=\"color_review_book\">학습교재</a></li>";
							$PageMyPageRoomHTML .= "<li style=\"width:45%;\"><a href=\"#\" onclick=\"".$LinkQuiz."\" class=\"color_review_quiz\">리뷰퀴즈</a></li>";
						}
					...
					if ($CurrentDateType==0 || $CurrentDateType>0){
						...
						if ($ClassID==0){
							if ($ClassMemberType==1){// 1:1 수업
								if ($MemberID==13591) {
									$PageMyPageRoomHTML .= "<li id=\"BtnResetDate\" style=\"width:100%;\"><a class=\"color_postpone\">수업연기요청</a></li>";
								} else {
									$PageMyPageRoomHTML .= "<li id=\"BtnResetDate\" style=\"width:100%;\"><a href=\"#\" onclick=\"javascript:OpenResetDateFormWithReg(".$ClassOrderID.", ".$SelectYear.", ".(int)$SelectMonth.", ".(int)$SelectDay.", ".(int)$StudyTimeHour.", ".(int)$StudyTimeMinute.", ".$ClassOrderTimeTypeID.", ".$TeacherID.", ".$MemberID.", ".$ClassMemberType.", ".$ClassProductID.");\" class=\"color_postpone\">수업연기요청</a></li>";
								}
							}else{
								if ($MemberID==13591) {
									$PageMyPageRoomHTML .= "<li id=\"BtnResetDate\" style=\"width:100%;\"><a class=\"color_postpone\">수업연기요청</a></li>";
								} else {
									$PageMyPageRoomHTML .= "<li id=\"BtnResetDate\" style=\"width:100%;\"><a href=\"#\" onclick=\"OpenResetDateFormErr();\" class=\"color_postpone\">수업연기요청</a></li>";
								}
							}
						}else{
							if ($ClassAttendState==4 || $ClassAttendState==5 || $ClassAttendState==6 || $ClassAttendState==7 || $ClassAttendState==8 || $ClassState==2){
								...
								if ($ClassMemberType==1){// 1:1 수업
									if ($MemberID==13591) {
										...
										$PageMyPageRoomHTML .= "<li id=\"BtnResetDate\" style=\"width:100%;\"><a href=\"#\" onclick=\"OpenResetDateForm(".$ClassID.", ".$ClassProductID.", ".(int)$StudyTimeHour.", ".(int)$StudyTimeMinute.");\" class=\"color_postpone\">수업연기요청</a></li>";
									}
								}else{
									if ($MemberID==13591) {
										$PageMyPageRoomHTML .= "<li id=\"BtnResetDate\" style=\"width:100%;\"><a class=\"color_postpone\">수업연기요청</a></li>";
					...
					if ($ClassProductID!=2 && $AssmtStudentDailyScoreID!=0){//데일리 평가보고
						$PageMyPageRoomHTML .= "<li style=\"width:100%;\"><a href=\"#\" onclick=\"OpenStudentScoreDailyReport(".$ClassID.");\" class=\"color_review_quiz\" style=\"background-color:#3D3D3D;\">평가보고서</a></li>";
					}else if ($ClassProductID==2 && $AssmtStudentLeveltestScoreID!=0){
						$PageMyPageRoomHTML .= "<li style=\"width:100%;\"><a href=\"#\" onclick=\"OpenStudentScoreLeveltestReport(".$AssmtStudentLeveltestScoreID.");\" class=\"color_review_quiz\" style=\"background-color:#3D3D3D;\">평가보고서</a></li>";
					}

					if ($ClassState==2 && $ClassProductID==1){
						$PageMyPageRoomHTML .= "<li style=\"width:100%;\"><a href=\"#\" onclick=\"OpenTeacherScoreForm(".$ClassID.");\" class=\"color_review_quiz\" style=\"background-color:#0080C0;\">강사평가</a></li>";
					}
...
if ($ListCount==1){
	...
	$PageMyPageRoomHTML .= "<li>";
	$PageMyPageRoomHTML .= "	<div class=\"schedule_inner\">";
	$PageMyPageRoomHTML .= "		<div class=\"schedule_time\" style=\"height:200px;\"><img src=\"".$ServerPath."images/icon_clock_black.png\" class=\"icon\">등록된 수업이 없습니다.</div>";
	$PageMyPageRoomHTML .= "	</div>";
	$PageMyPageRoomHTML .= "	<ul class=\"schedule_btns\">";
	$PageMyPageRoomHTML .= "		<li><a href=\"main.html\" class=\"color_postpone\">닫기</a></li>";
	$PageMyPageRoomHTML .= "	</ul>";
	$PageMyPageRoomHTML .= "</li>";
...
$PageMyPageRoomHTML .= "	
	...
	<h3 class=\"caption_left_common\"><b>학습캘린더</b> 버튼 설명</h3>
