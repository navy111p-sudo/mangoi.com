	...
	<div id="bbs">
		...
		<div class="BtnCenter">
			<div class="left" style="display:none;">
				...
				<a href="board_list.php?<?=str_replace("^^", "&", $ListParam)?>" class="BtnGray" style="width:80px;">목 록</a>
				<?php 
				if ($EnableReplay && $AuthReply){
				?>
				<a href="board_form.php?ListParam=<?=$ListParam?>&BoardContentID=<?=$BoardContentID?>&BoardCode=<?=$BoardCode?>&boardcontentreplyid=<?=$BoardContentReplyID?>" class="BtnGray" style="width:80px;">답 글</a>
				<?php
				}
				?>
				<?php
				...
				?>
				<a href="javascript:ModifyContent();" class="BtnGray" style="width:80px;">수 정</a>			
				<a href="javascript:DeleteContent();" class="BtnGray" style="width:80px;">삭 제</a>
				<?php
				}
				?>
