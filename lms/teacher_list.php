							...
							<table class="uk-table uk-table-align-vertical">
								...
								<tbody>
									...
									<tr>
										...
										<?	if ($StaffID == 0) {?>
											<a type="button" href="staff_add_action.php?MemberID=<?=$MemberID?>&StaffName=<?=$TeacherName?>&StaffNickName=<?=$TeacherNickName?>&FranchiseID=<?=$FranchiseID?>&StaffPhone1=<?=$TeacherPhone1?>&StaffPhone2=<?=$TeacherPhone2?>" class="md-btn md-btn-primary">직원 등록하기</a>
										<? } else { ?>
											<a type="button" href="staff_del_action.php?MemberID=<?=$MemberID?>&StaffID=<?=$StaffID?>" class="md-btn md-btn-worning">직원 제거하기</a>
										<?}	?>
										</td>
									</tr>
									<?php
