...
<div id="page_content">
    <div id="page_content_inner">
        <h3 class="heading_b uk-margin-bottom"><?=$MemberName?>님<span style="font-size:0.6em;">(<?=$OrganTask1Name?> > <?=$OrganTask2Name?>)</span> 역량평가</h3>
                            ...
                            #-------------------------------------------------------------------------------------------------------------#
									...
									*/
                                    ...
                                    <tr>
                                        ...
                                        <td class="uk-text-nowrap uk-table-td-center"><input type="radio" id="CPoint1_<?=$line_cnt?>" name="CPoint_<?=$line_cnt?>" <?=$CPCHK5?> <?=$CP_Disable?> value="5"></td>
                                        <td class="uk-text-nowrap uk-table-td-center"><input type="radio" id="CPoint2_<?=$line_cnt?>" name="CPoint_<?=$line_cnt?>" <?=$CPCHK4?> <?=$CP_Disable?> value="4"></td>
                                        <td class="uk-text-nowrap uk-table-td-center"><input type="radio" id="CPoint3_<?=$line_cnt?>" name="CPoint_<?=$line_cnt?>" <?=$CPCHK3?> <?=$CP_Disable?> value="3"></td>
                                        <td class="uk-text-nowrap uk-table-td-center"><input type="radio" id="CPoint4_<?=$line_cnt?>" name="CPoint_<?=$line_cnt?>" <?=$CPCHK2?> <?=$CP_Disable?> value="2"></td>
                                        <td class="uk-text-nowrap uk-table-td-center"><input type="radio" id="CPoint5_<?=$line_cnt?>" name="CPoint_<?=$line_cnt?>" <?=$CPCHK1?> <?=$CP_Disable?> value="1"></td>
                                    </tr>
...
function Competency_Clear() {
       ...
       //-----------------------------------------------------------------------------------------------------------------//
       UIkit.modal.confirm(
                 '<?=$역량평가를_삭제_하시겠습니까[$LangID]?><br><?=$한번_삭제된_자료는_복구할_수_없습니다[$LangID]?>', 
                 function(){ 
