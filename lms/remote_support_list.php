...
if ($SearchState!="100"){
	...
	$AddSqlWhere = $AddSqlWhere . " and A.RemoteSupportMemberState=$SearchState ";
}
$AddSqlWhere = $AddSqlWhere . " and A.RemoteSupportMemberState<>0 ";
...
$Sql = "
		...
		where ".$AddSqlWhere." 
		order by A.RemoteSupportMemberRegDateTime desc limit $StartRowNum, $PageListNum";
...
<div id="page_content">
	<div id="page_content_inner">
		...
		<h3 class="heading_b uk-margin-bottom"><?=$원격지원목록[$LangID]?></h3>
				...
				<div class="uk-grid" data-uk-grid-margin>
					<div class="uk-width-1-1">
							...
							<table class="uk-table uk-table-align-vertical">
								<thead>
									<tr>
										...
										<th style="width:10%" nowrap><?=$예약시간[$LangID]?></th>
										<th nowrap><?=$신청사유[$LangID]?></th>
								...
								<tbody>
									...
									while($Row = $Stmt->fetch()) {
										...
										$RemoteSupportMemberID = $Row["RemoteSupportMemberID"];
										...
										$RemoteSupportMemberStartDateTime = $Row["RemoteSupportMemberStartDateTime"];
										$RemoteSupportMemberEndDateTime = $Row["RemoteSupportMemberEndDateTime"];
										$RemoteSupportMemberRegDateTime = $Row["RemoteSupportMemberRegDateTime"];
										$RemoteSupportMemberState = $Row["RemoteSupportMemberState"];
										
										
										if ($RemoteSupportMemberState==1){
											$StrRemoteSupportMemberState = "미처리";
										}else if ($RemoteSupportMemberState==2){
											$StrRemoteSupportMemberState = "처리완료";
										}
									...
									<tr>
										...
										<td class="uk-text-nowrap uk-table-td-center"><a href="javascript:OpenRemoteSupportMemberForm(<?=$RemoteSupportMemberID?>)"><?=$MemberName?></a></td>
										...
										<td class="uk-text-nowrap uk-table-td-center"><?=$RemoteSupportMemberStartDateTime?></td>
										<td class="uk-text-nowrap uk-table-td"><?=$RemoteSupportMemberContent?></td>
										<td class="uk-text-nowrap uk-table-td-center"><?=$RemoteSupportMemberRegDateTime?></td>
										<td class="uk-text-nowrap uk-table-td-center"><?=$StrRemoteSupportMemberState?></td>
									</tr>
									<?php
										$ListCount ++;
									}
						...
						<div class="uk-form-row" style="text-align:center;">
							<a type="button" href="javascript:OpenRemoteSupportMemberForm('')" class="md-btn md-btn-primary"><?=$신규등록[$LangID]?></a>
						</div>
...
<!-- ============== only this page js ============== -->
<script>
function OpenRemoteSupportMemberForm(RemoteSupportMemberID){
	openurl = "remote_support_form.php?RemoteSupportMemberID="+RemoteSupportMemberID;
	$.colorbox({	
		href:openurl
		,width:"95%" 
		,height:"95%"
...
function SearchSubmit(){
	document.SearchForm.action = "remote_support_list.php";
