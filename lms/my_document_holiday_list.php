...
$AddSqlWhere = "1=1 AND A.DocumentReportState <> 0";
$ListParam = "1=1";
$PaginationParam = "1=1";
...
$AddSqlWhere = $AddSqlWhere . " and A.DocumentID=2 ";  // DocumentID 가 2 이면 휴가 및 병가원 99이면 기안 및 지출품의서
					...
					<div class="uk-width-medium-1-10">
						<div class="uk-margin-small-top">
							<select id="SearchState" name="SearchState" onchange="SearchSubmit()" data-md-selectize  data-md-selectize-bottom>
								...
								<option value="1" <?if ($SearchState=="1"){?>selected<?}?>><?=$제출완료[$LangID]?></option>
								<option value="2" <?if ($SearchState=="2"){?>selected<?}?>><?=$작성중[$LangID]?></option>
							</select>
						</div>
					</div>
				...
				<div class="uk-grid" data-uk-grid-margin>
					<div class="uk-width-1-1">
							...
							<table class="uk-table uk-table-align-vertical">
								...
								<tbody>
									...
									<tr>
										...
										<td class="uk-text-nowrap"><a href="my_document_holiday_form.php?ListParam=<?=$ListParam?>&DocumentReportID=<?=$DocumentReportID?>"><?=$DocumentReportName?></a></td>
										...
										<td class="uk-text-nowrap uk-table-td-center">
											...
											$Sql3 = "SELECT A.*, B.MemberName 
														...
														where A.DocumentReportID=".$DocumentReportID." order by B.MemberName asc";
										...
										<td class="uk-text-nowrap uk-table-td-center"><a type="button" href="my_document_holiday_form.php?ListParam=<?=$ListParam?>&DocumentReportID=<?=$DocumentReportID?>&CopyMode=1" class="md-btn md-btn-primary"><?=$문서복사새문서[$LangID]?></a></td>
									</tr>
									<?php
										$ListCount ++;
									}
						...
						<div class="uk-form-row" style="text-align:center;">
							<a type="button" href="my_document_holiday_form.php?ListParam=<?=$ListParam?>" class="md-btn md-btn-primary"><?=$신규등록[$LangID]?></a>
						</div>
...
function SearchSubmit(){
	document.SearchForm.action = "<?=$_SERVER["PHP_SELF"]?>";
