...
<div id="page_content">
	<div id="page_content_inner">
		...
		<h3 class="heading_b uk-margin-bottom"><?=$수업시간구성관리[$LangID]?></h3>
							...
							<table class="uk-table uk-table-align-vertical">
								...
								<tbody>
									...
									<tr>
										...
										<td class="uk-text-nowrap uk-table-td-center"><a href="javascript:OpenMemberForm(<?=$MemberID?>, '<?=$MemberName?>')"><?=$MemberName?></td>
										<!--
...
function OpenMemberForm(MemberID, MemberName) {

	parent.document.RegForm.MemberID.value = MemberID;
	parent.document.RegForm.MemberName.value = MemberName;
...
function SearchSubmit(){
	document.SearchForm.action = "center_class_member_form_open.php";
