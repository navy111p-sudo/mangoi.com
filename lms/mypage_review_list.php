...
if ($SearchState!="100"){
	...
	$AddSqlWhere = $AddSqlWhere . " and A.ReviewClassMemberState=$SearchState ";
}
$AddSqlWhere = $AddSqlWhere . " and A.ReviewClassMemberState<>0 ";
...
<div id="page_content">
	<div id="page_content_inner">
		...
		<h3 class="heading_b uk-margin-bottom"><?=$수강후기[$LangID]?></h3>
				...
				<div class="uk-grid" data-uk-grid-margin>
					<div class="uk-width-1-1">
							...
							<table class="uk-table uk-table-align-vertical">
								...
								<tbody>
									...
									while($Row = $Stmt->fetch()) {
										...
										$ReviewClassMemberID = $Row["ReviewClassMemberID"];
										...
										if ($ReviewClassMemberState==1){
											$StrReviewClassMemberState = $답변전[$LangID];
										}else if ($ReviewClassMemberState==2){
											$StrReviewClassMemberState = $답변완료[$LangID];
										}
									...
									<tr>
										...
										<td class="uk-text-nowrap"><a href="javascript:OpenMypageReviewMemberForm(<?=$ReviewClassMemberID?>)"><?=$ReviewClassMemberTitle?></td>
										...
										<td class="uk-text-nowrap uk-table-td-center"><?=$ReviewClassMemberRegDateTime?></td>
										<td class="uk-text-nowrap uk-table-td-center"><?=$ReviewClassMemberAnswerRegDateTime?></td>
										<td class="uk-text-nowrap uk-table-td-center"><?=$StrReviewClassMemberState?></td>
									</tr>
									<?php
										$ListCount ++;
									}
						...
						<div class="uk-form-row" style="text-align:center;">
							<a type="button" href="javascript:OpenMypageReviewMemberForm('')" class="md-btn md-btn-primary"><?=$신규등록[$LangID]?></a>
						</div>
						-->
...
<!-- ============== only this page js ============== -->
<script>
function OpenMypageReviewMemberForm(ReviewClassMemberID){
	openurl = "mypage_review_member_form.php?ReviewClassMemberID="+ReviewClassMemberID;
	$.colorbox({	
		href:openurl
		,width:"95%" 
		,height:"95%"
...
function SearchSubmit(){
	document.SearchForm.action = "mypage_review_list.php";
