...
if ($SearchState!="100"){
	...
	$AddSqlWhere = $AddSqlWhere . " and A.RequestMemberState=$SearchState ";
}
$AddSqlWhere = $AddSqlWhere . " and A.RequestMemberState<>0 ";
...
$Sql = "
		...
		where ".$AddSqlWhere." 
		order by A.RequestMemberRegDateTime desc limit $StartRowNum, $PageListNum";
				...
				<div class="uk-grid" data-uk-grid-margin>
					<div class="uk-width-1-1">
							...
							<table class="uk-table uk-table-align-vertical">
								...
								<tbody>
									...
									while($Row = $Stmt->fetch()) {
										...
										if ($RequestMemberState==1){
											$StrRequestMemberState = "답변전";
										}else if ($RequestMemberState==2){
											$StrRequestMemberState = "답변완료";
										}
									...
									<tr>
										...
										<td class="uk-text-nowrap"><a href="javascript:OpenRequestMemberForm(<?=$RequestMemberID?>)"><?=$RequestMemberTitle?></td>
										...
										<td class="uk-text-nowrap uk-table-td-center"><?=$RequestMemberRegDateTime?></td>
										<td class="uk-text-nowrap uk-table-td-center"><?=$RequestMemberAnswerRegDateTime?></td>
										<td class="uk-text-nowrap uk-table-td-center"><?=$StrRequestMemberState?></td>
									</tr>
									<?php
										$ListCount ++;
									}
						...
						<div class="uk-form-row" style="text-align:center;">
							<a type="button" href="javascript:OpenRequestMemberForm('')" class="md-btn md-btn-primary"><?=$신규등록[$LangID]?></a>
						</div>
...
<!-- ============== only this page js ============== -->
<script>
function OpenRequestMemberForm(RequestMemberID){
	openurl = "request_member_form.php?RequestMemberID="+RequestMemberID;
	$.colorbox({	
		href:openurl
		,width:"95%" 
		,height:"95%"
...
function SearchSubmit(){
	document.SearchForm.action = "request_member_list.php";
