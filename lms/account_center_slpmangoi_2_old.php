...
<div id="page_content">
	<div id="page_content_inner">
		...
		<h3 class="heading_b uk-margin-bottom">SLP 정산(본사로얄티)</h3>
							...
							<table class="uk-table uk-table-align-vertical">
								...
								<tbody>
									...
									while($Row = $Stmt->fetch()) {
										...
										$ClassOrderPayPgFee = $Row["ClassOrderPayPgFee"];
										...
										$SumClassOrderPayCount = $SumClassOrderPayCount + $ClassOrderPayCount;
									...
									<tr>
										...
										<td class="uk-text-nowrap uk-table-td-center"><?=number_format($StudentCount,0)?><!-- 학생수 --></td>
										<td class="uk-text-nowrap uk-table-td-center"><?=number_format($StudyStudentCount,0)?><!-- 수강인원 --></td>
										<td class="uk-text-nowrap uk-table-td-center"><?=number_format($ClassOrderPayUseCashPrice,0)?><!-- 총 결제금액 --></td>
										<td class="uk-text-nowrap uk-table-td-center"><?=number_format($ClassOrderPayCount,0)?><!-- 결제+환불 인원 --></td>
									...
									?>
									<tr>
										<th class="uk-text-nowrap uk-table-td-center" colspan="5">합 계</th>
						
										<th class="uk-text-nowrap uk-table-td-center"><?=number_format($SumClassOrderPayUseCashPrice,0)?><!-- 총 결제금액 --></th>
										<th class="uk-text-nowrap uk-table-td-center"><?=number_format($SumClassOrderPayCount,0)?><!-- 결제+환불 인원 --></th>
										<th class="uk-text-nowrap uk-table-td-center"><?=number_format($SumCompayRoyalty, 0)?><!-- 본사 로얄티<br>(A) --></th>
										<th class="uk-text-nowrap uk-table-td-center"><?=number_format($SumCompayRoyalty-$SumTrueCompayRoyalty, 0)?><!-- 결제 수수료<br>(B) --></th>
										<th class="uk-text-nowrap uk-table-td-center"><?=number_format($SumTrueCompayRoyalty, 0)?><!-- 실 정산금액<br>(Z=A-B) --></th>
									</tr>
								</tbody>
							</table>
...
function SearchSubmit(){
	document.SearchForm.action = "account_center_slpmangoi_2_old.php";
