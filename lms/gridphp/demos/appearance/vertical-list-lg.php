...
$col["sortable"] = false;
$col["search"] = false;
$col["template"] = "<div style='background-image: url(../../assets/img/products/{product_id}.jpg); max-width:100px; max-height:100px; width:100px; height: 30px; background-position-y: center;'><img style='display:none' src='../../assets/img/products/{product_id}.jpg' /></div>";
$cols[] = $col;
...
$col["width"] = "100";
$col["visible"] = "lg+"; // only for xs screens
$col["viewable"] = false;
$col["editable"] = false; // this column is not editable
$col["search"] = false; // this column is not searchable
$col["template"] = "<div class='xs_row'>

	<div style='float:left; width:10%'><img width='100%' src='../../assets/img/products/{product_id}.jpg'></div>
