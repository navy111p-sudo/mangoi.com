...
// $grid["afterSubmitCell"] = "function(serverresponse, rowid, cellname, value, iRow, iCol) { setTimeout( ()=>{ jQuery(this).trigger('reloadGrid'); }, 200); return [true, '']; }";
...
$grid["loadComplete"] = "function(){ set_grid_footer(); }";
