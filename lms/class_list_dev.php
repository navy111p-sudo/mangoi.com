													...
													where 
														...
														and
															(
																...
																(V.CenterPayType=1 and V.MemberPayType=0 and ((V.ClassOrderState=1 or V.ClassOrderState=2 or V.ClassOrderState=5 or V.ClassOrderState=6) or (V.ClassOrderState=3 and datediff(V.ClassOrderEndDate, '".$SelectDate."')>=0) ))  
																or 
																( 
...
function SearchSubmit(){
	document.SearchForm.action = "class_list_dev.php";
    document.SearchForm.submit();
}
</script>
