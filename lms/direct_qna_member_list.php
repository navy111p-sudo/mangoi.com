							...
							<table class="uk-table uk-table-align-vertical">
								...
								<tbody>
									...
									while($Row = $Stmt->fetch()) {
										...
										$DirectQnaMemberID = $Row["DirectQnaMemberID"];
										...
										if ($DirectQnaMemberState==1){
											$StrDirectQnaMemberState = "<?=$답변전[$LangID]?>";
										}else if ($DirectQnaMemberState==2){
											$StrDirectQnaMemberState = "<?=$답변완료[$LangID]?>";
										}
									...
									<tr>
										...
										<td class="uk-text-nowrap"><a href="javascript:OpenDirectQnaMemberForm(<?=$DirectQnaMemberID?>)"><?=$DirectQnaMemberTitle?></td>
										...
										<td class="uk-text-nowrap uk-table-td-center"><?=$DirectQnaMemberRegDateTime?></td>
										<td class="uk-text-nowrap uk-table-td-center"><?=$DirectQnaMemberAnswerRegDateTime?></td>
										<td class="uk-text-nowrap uk-table-td-center"><?=$StrDirectQnaMemberState?></td>
									</tr>
									<?php
										$ListCount ++;
									}
...
<!-- ============== only this page js ============== -->
<script>
function OpenDirectQnaMemberForm(DirectQnaMemberID){
	openurl = "direct_qna_member_form.php?DirectQnaMemberID="+DirectQnaMemberID;
	$.colorbox({	
		href:openurl
		,width:"95%" 
		,height:"95%"
...
function SearchSubmit(){
	document.SearchForm.action = "direct_qna_member_list.php";
