...
if ($SearchPhone!=""){
    ...
    $AddSqlWhere2 .= " and (V.DecMemberPhone1 like :SearchPhoneLike or V.DecMemberPhone2 like :SearchPhoneLike or V.DecMemberPhone3 like :SearchPhoneLike) ";
}
			...
			<div class="md-card-content">
				<div class="uk-grid" data-uk-grid-margin="">
					...
					<div class="uk-width-medium-2-10">
						<label for="SearchText"><?=$학생명_또는_아이디[$LangID]?> (Enter를 눌러서 검색)</label>
...
<script>
$(function(){
    $('#SearchText, #SearchText2, #SearchPhone').on('keydown', function(e){
        if(e.keyCode==13){
            e.preventDefault();
            SearchSubmit();
        }
...
function SearchSubmit(){
	// document.SearchForm.action = "student_list.php";
	// document.SearchForm.submit();
    document.SearchForm.action = "student_list.php";
    document.SearchForm.submit();
}
