...
if ($SearchState!="100"){
	...
	$AddSqlWhere = $AddSqlWhere . " and A.QnaMemberState=$SearchState ";
}
$AddSqlWhere = $AddSqlWhere . " and A.QnaMemberState<>0 ";
...
$Sql = "
		...
		where ".$AddSqlWhere." 
		order by A.QnaMemberRegDateTime desc limit $StartRowNum, $PageListNum";
				...
				<div class="uk-grid" data-uk-grid-margin>
					<div class="uk-width-1-1">
							...
							<table class="uk-table uk-table-align-vertical">
								...
								<tbody>
									...
									while($Row = $Stmt->fetch()) {
										...
										if ($QnaMemberState==1){
											$StrQnaMemberState = "답변전";
										}else if ($QnaMemberState==2){
											$StrQnaMemberState = "답변완료";
										}
									...
									<tr>
										...
										<td class="uk-text-nowrap"><a href="javascript:OpenQnaMemberForm(<?=$QnaMemberID?>)"><?=$QnaMemberTitle?></td>
										...
										<td class="uk-text-nowrap uk-table-td-center"><?=$QnaMemberRegDateTime?></td>
										<td class="uk-text-nowrap uk-table-td-center"><?=$QnaMemberAnswerRegDateTime?></td>
										<td class="uk-text-nowrap uk-table-td-center"><?=$StrQnaMemberState?></td>
									</tr>
									<?php
										$ListCount ++;
									}
						...
						<div class="uk-form-row" style="text-align:center;">
							<a type="button" href="javascript:OpenQnaMemberForm('')" class="md-btn md-btn-primary"><?=$신규등록[$LangID]?></a>
						</div>
...
<!-- ============== only this page js ============== -->
<script>
function OpenQnaMemberForm(QnaMemberID){
	openurl = "qna_member_form.php?QnaMemberID="+QnaMemberID;
	$.colorbox({	
		href:openurl
		,width:"95%" 
		,height:"95%"
...
function SearchSubmit(){
	document.SearchForm.action = "qna_member_list.php";
