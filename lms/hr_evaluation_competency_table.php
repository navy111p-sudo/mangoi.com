...
<div id="page_content">
	<div id="page_content_inner">
		...
		<h3 class="heading_b uk-margin-bottom"><?=$역량평가_조직도[$LangID]?></h3>
			...
			<div class="md-card-content">
				<div class="uk-grid" data-uk-grid-margin="">
					...
					<div class="uk-width-medium-4-10">
						<div class="uk-margin-small-top">
                           <input type="file" id="EvaluationCompetencyData" name="EvaluationCompetencyData" style="width:100%;">   
						</div>
						<a href="javascript:EvaluationCompetencyTable_Upload();" class="md-btn md-btn-primary uk-margin-small-top"><?=$일괄_엑셀자료_올리기[$LangID]?></a>
						<a href="EvaluationCompetencyTable.xlsx" class="md-btn md-btn-primary uk-margin-small-top" style="background:#408080;"><?=$역량평가_엑셀자료구조_다운로드[$LangID]?></a>
					</div>
					<div class="uk-width-medium-3-10 uk-text-center">
						<a href="javascript:EvaluationCompetencyTable_DataIn();" class="md-btn md-btn-primary uk-margin-small-top" style="background:#74A63E;"><?=$개별_평가대상자_및_평가자_등록[$LangID]?></a>
					</div>
				</div>
			</div>
		</div>
					...
					<div class="uk-width-1-1">
						<div class="uk-overflow-container">
							<table class="uk-table uk-table-align-vertical">
								<thead>
									<tr>
										<th nowrap colspan="5" style="border-bottom:0px;"><?=$평가대상자[$LangID]?></th>
							...
							$Sql = "SELECT  
									...
									while($Row = $Stmt->fetch()) {
										...
										if ($OldMemberID!=$MemberID){
											...
											?>
											<tr>
												<td colspan="4" class="uk-text-nowrap uk-table-td-right"><?=$평가자_가중치_소계[$LangID]?></td>
									...
									<tr>
										<?if ($PrintMember==1){?>
											...
											<td class="uk-text-nowrap uk-table-td-left"   rowspan="<?=$T_MemberCount?>"><?=$MemberName?></td>
											...
											<td class="uk-text-nowrap uk-table-td-center" rowspan="<?=$T_MemberCount?>">
											   <a class="md-btn md-btn-success md-btn-mini md-btn-wave-light" href="javascript:InsertStaffCompetencyMember(<?=$MemberID?>,'<?=$MemberName?>')">추가 ▶</a><br><br>
											   <a class="md-btn md-btn-success md-btn-mini md-btn-wave-light" href="javascript:DeleteStaffCompetencyMember(<?=$MemberID?>, <?=$MemberID?>, '<?=$MemberName?>')">◀ 삭제</a>
											</td>
										<?}?>


										<td class="uk-text-nowrap uk-table-td-left"><?=$T_MemberName?></td>
										...
										<td class="uk-text-nowrap uk-table-td-center">
											<a class="md-btn md-btn-success md-btn-mini md-btn-wave-light" href="javascript:DeleteStaffCompetencyMember(<?=$MemberID?>, <?=$T_MemberID?>, '<?=$T_MemberName?>')">◀ 삭제</a>
										</td>
									</tr>
									<?php
									}
...
function DeleteStaffCompetencyMember(MemberID, Hr_EvaluationCompetencyMemberID=null,MemberName='') {
	...
	if (MemberID==Hr_EvaluationCompetencyMemberID) {
         var evaluation_confirm = MemberName + "<?=$평가대상자를_삭제_하시겠습니까[$LangID]?>?";
	}
...
function SearchSubmit(){
	document.SearchForm.action = "hr_evaluation_competency_table.php";
	document.SearchForm.submit();
}
</script>
