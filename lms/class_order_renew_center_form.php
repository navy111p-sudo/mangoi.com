	...
	$CenterRenewStartMonth = (int)$CenterRenewStartMonth;
        ...
        $Sql = "SELECT
                        ...
                        where
                                ...
                                and (B.ClassOrderPayProgress=21 or B.ClassOrderPayProgress=41)
        ";
	$Stmt = $DbConn->prepare($Sql);
	$Stmt->bindParam(':CenterID', $SearchCenterID);
...
$ClassOrderPayB2bsViewTable = "SELECT
    ...
    where 
        COP.ClassOrderPayProgress IN (21, 41)
";
...
<div id="page_content">
	<div id="page_content_inner">
		...
		<h3 class="heading_b uk-margin-bottom"><?=$수강연장[$LangID]?></h3>
							...
							<table class="uk-table uk-table-align-vertical" style="width:100%;">
								<thead>
									<tr>
										...
										<th nowrap><?=$수강[$LangID]?><br><?=$시작일[$LangID]?><br><?=$종료일[$LangID]?><br><?=$상태[$LangID]?></th>
										<th nowrap><?=$수강[$LangID]?><br><?=$회수[$LangID]?></th>
										<th nowrap><?=$수업[$LangID]?><br><?=$스케줄[$LangID]?></th>
										<th nowrap><?=$수업[$LangID]?><br><?=$타입[$LangID]?></th>
										<th nowrap><?=$지지난달[$LangID]?><br><?=$결제한[$LangID]?><br><?=$수업수[$LangID]?></th>
										<th nowrap><?=$지지난달[$LangID]?><br><?=$결제한[$LangID]?><br><?=$수강료[$LangID]?><br>(a)</th>
										<th nowrap><?=$지난달[$LangID]?><br><?=$진행한[$LangID]?><br><?=$수업수[$LangID]?></th>
										<th nowrap><?=$지난달[$LangID]?><br><?=$진행한[$LangID]?><br><?=$수강료[$LangID]?><br>(b)</th>
										<th nowrap><?=$지난달[$LangID]?><br><?=$실수강료[$LangID]?><br><?=$차액[$LangID]?><br>(c=a-b)</th>
										<th nowrap><?=$다음달[$LangID]?><br><?=$예상[$LangID]?><br><?=$수업수[$LangID]?></th>
										<th nowrap><?=$다음달[$LangID]?><br><?=$예상[$LangID]?><br><?=$수강료[$LangID]?><br>(d)</th>

										<th nowrap><?=$첫수강[$LangID]?><br><?=$무료체험[$LangID]?><br><?=$수업수[$LangID]?></th>
										<th nowrap><?=$첫수강[$LangID]?><br><?=$무료체험[$LangID]?><br><?=$할인[$LangID]?><br>(e)</th>

										<th nowrap><?=$이번달[$LangID]?><br><?=$결제할[$LangID]?><br><?=$수강료[$LangID]?><br>(f=d-c-e)</th>
									</tr>
								</thead>
								<tbody>
								...
								if ($SearchCenterID!=""){
									...
									<tr style="background-color:<?if ($ClassOrderPayB2bID!=0){?>#F9FCFF<?}?>;">
										...
										<td class="uk-text-nowrap uk-table-td-center" style="text-align:left;">
											<!--수업스케줄-->
											<?
										...
										?>
											...
											<td class="uk-text-nowrap uk-table-td-center" rowspan="<?=$GroupRowCount?>">
                                                ...
                                                if ($ClassOrderPayB2bID != 0){          // 이미 이번달 선불 결제 완료된 행
                                                    $PrevMonthUsedMoney               = 0;
										...
										?>
											...
											<td class="uk-text-nowrap uk-table-td-center">
												...
												$DifferencePrevPrevMonthPaidMoney = $PrevPrevMonthPaidMoney-$PrevMonthUsedMoney;
                                                if ($ClassOrderPayB2bID != 0){
                                                    $PrevMonthUsedMoney = 0;   // 이미 결제된 개인·듀오 행
												}
											...
											<td class="uk-text-nowrap uk-table-td-center">
												<!--이번달 결제할 수강료(d-c)-->
												<?
												$DifferenceNextMonthPayMoney = $NextMonthPayMoney-($PrevPrevMonthPaidMoney-$PrevMonthUsedMoney) - $ClassOrderPayLogClassOrderPayFreeTrialDiscountPrice;
								...
								<tr style="display:<?if ($PrePayClassOrderPayCount>0){?>none<?}?>">
									...
									<th nowrap><?=number_format($SumPrevPrevMonthPaidClassCount,0)?></th>
									<th nowrap><?=number_format($SumPrevPrevMonthPaidMoney,0)?></th>
									<th nowrap><?=number_format($SumPrevMonthEndClassCount,0)?></th>
									<th nowrap><?=number_format($SumPrevMonthUsedMoney,0)?></th>
									<th nowrap><?=number_format($SumDifferencePrevPrevMonthPaidMoney,0)?></th>
									<th nowrap><?=number_format($SumNextMonthClassCount,0)?></th>
									<th nowrap><?=number_format($SumNextMonthPayMoney,0)?></th>
									<th nowrap><?=number_format($SumClassOrderPayLogCalCenterFreeTrialCount,0)?></th>
									<th nowrap><?=number_format($SumClassOrderPayLogClassOrderPayFreeTrialDiscountPrice,0)?></th>
								...
								<tr>
									...
									<th nowrap style="background-color:#c1c1c1;color:#000000;" id="CheckPaySumPrevPrevMonthPaidClassCount">0</th>
									<th nowrap style="background-color:#c1c1c1;color:#000000;" id="CheckPaySumPrevPrevMonthPaidMoney">0</th>
									<th nowrap style="background-color:#c1c1c1;color:#000000;" id="CheckPaySumPrevMonthEndClassCount">0</th>
									<th nowrap style="background-color:#c1c1c1;color:#000000;" id="CheckPaySumPrevMonthUsedMoney">0</th>
									<th nowrap style="background-color:#c1c1c1;color:#000000;" id="CheckPaySumDifferencePrevPrevMonthPaidMoney">0</th>
									<th nowrap style="background-color:#c1c1c1;color:#000000;" id="CheckPaySumNextMonthClassCount">0</th>
									<th nowrap style="background-color:#c1c1c1;color:#000000;" id="CheckPaySumNextMonthPayMoney">0</th>
									<th nowrap style="background-color:#c1c1c1;color:#000000;" id="CheckPaySumClassOrderPayLogCalCenterFreeTrialCount">0</th>
									<th nowrap style="background-color:#c1c1c1;color:#000000;" id="CheckPaySumClassOrderPayLogClassOrderPayFreeTrialDiscountPrice">0</th>
								...
								<tr>
									...
									<th nowrap style="background-color:#c1c1c1;color:#000000;" colspan="4"></th>
									<th nowrap style="background-color:#c1c1c1;color:#000000;" id="NoCheckPaySumDifferencePrevPrevMonthPaidMoney">
										0
									</th>
									<th nowrap style="background-color:#c1c1c1;color:#000000;" colspan="4"></th>
								...
								<tr>
									...
									<th nowrap style="background-color:#888888;color:#ffffff;" colspan="4"></th>
									<th nowrap style="background-color:#888888;color:#ffffff;" id="PaySumDifferencePrevPrevMonthPaidMoney">0</th>
									<th nowrap style="background-color:#888888;color:#ffffff;" colspan="4"></th>
