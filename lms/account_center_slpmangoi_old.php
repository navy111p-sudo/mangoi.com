...
<div id="page_content">
	<div id="page_content_inner">
		...
		<h3 class="heading_b uk-margin-bottom">SLP 정산(학당지원금)</h3>
							...
							<table class="uk-table uk-table-align-vertical">
								...
								<tbody>
									...
									<tr>
										...
										<th class="uk-text-nowrap uk-table-td-center"><?=number_format($SumSupportCenterPrice, 0)?><!-- 학당 지원금<br>(A) --></th>
										<th class="uk-text-nowrap uk-table-td-center"><?=number_format($SumSupportCenterPrice-$SumTrueSupportCenterPrice, 0)?><!-- 결제 수수료<br>(B) --></th>
										<th class="uk-text-nowrap uk-table-td-center"><?=number_format($SumTrueSupportCenterPrice, 0)?><!-- 실 정산금액<br>(Z=A-B) --></th>
									</tr>
								</tbody>
							</table>
...
function SearchSubmit(){
	document.SearchForm.action = "account_center_slpmangoi_old.php";
