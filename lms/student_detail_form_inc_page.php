					...
					<ul id="user_edit_tabs_content" class="uk-switcher uk-margin">
						...
						<li>
							...
							<table class="uk-table uk-table-align-vertical">
								...
								<tr>
									<td class="uk-text-nowrap uk-table-td-center"><?=$ListCount?></td>
									<td class="uk-text-nowrap"><?=$레벨테스트[$LangID]?> (LEVEL <?=$AssmtStudentLeveltestScoreLevel?>)</td>
...
function OpenProductOrderCartForm(ProductOrderCartID){
	...
	$.colorbox({	
		...
		,iframe:true 
		,scrolling:true
		,onClosed:function(){location.href='student_detail_form.php?ListParam=<?=$ListParam?>&MemberID=<?=$MemberID?>&PageTabID=12';}
...
function FormSubmit(){
	...
	*/
	...
	UIkit.modal.confirm(
		'저장 하시겠습니까?', 
		function(){ 
			document.RegForm.action = "student_detail_action.php";
