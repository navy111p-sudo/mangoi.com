...
<footer>
	<div class="foot_1">
    	<ul class="foot_menu">
        	<li><a href="page.php?PageCode=mangoi" class="TrnTagCom">이엔지 화상영어 소개</a></li>
        ...
        <div class="foot_video"><a href="javascript:OpenSampleMain();"  class="TrnTagCom">이엔지 화상영어 수업영상 보러가기 <img src="images/btn_play_orange.png" alt="이엔지 화상영어 수업영상 보러가기" class="img"></a></div>
    </div>
    <div class="foot_2">
    	<div class="foot_2_wrap">
        	<div class="foot_left">
            	{{FooterLogo}}
                    <div class="foot_add">
	   {{FooterAddr1}}
                    <trn  class="TrnTagCom">통신판매업신고번호 : 제 2023-서울서초-3253호</trn>
                    <div class="break">개인정보 보호 책임자 : 임윤재(master@engedu.co.kr)</div>
                </div>
            </div>
            <div class="foot_right">
            	<b class="foot_center"><span class="TrnTagCom">고객만족센터</span>1566-4522</b>
