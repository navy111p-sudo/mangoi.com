...
<?
    ...
    /* =   지불 결과                                                                = */
    /* = -------------------------------------------------------------------------- = */
    $req_tx = isset($_POST["req_tx"]) ? $_POST["req_tx"] : "";      // 요청 구분(승인/취소)
    $pay_method = isset($_POST["pay_method"]) ? $_POST["pay_method"] : "";      // 사용 결제 수단
    $bSucc = isset($_POST["bSucc"]) ? $_POST["bSucc"] : "";      // 업체 DB 정상처리 완료 여부
    /* = -------------------------------------------------------------------------- = */
    $res_cd = isset($_POST["res_cd"]) ? $_POST["res_cd"] : "";      // 결과 코드
    $res_msg = isset($_POST["res_msg"]) ? $_POST["res_msg"] : "";      // 결과 메시지
    $res_msg_bsucc = "";
    $amount = isset($_POST["amount"]) ? $_POST["amount"] : "";      // 총금액
    $panc_mod_mny = isset($_POST["panc_mod_mny"]) ? $_POST["panc_mod_mny"] : "";      // 부분취소 요청금액
    $panc_rem_mny = isset($_POST["panc_rem_mny"]) ? $_POST["panc_rem_mny"] : "";      // 부분취소 가능금액
    ...
    $buyr_name = isset($_POST["buyr_name"]) ? $_POST["buyr_name"] : "";      // 구매자명
    $buyr_tel1 = isset($_POST["buyr_tel1"]) ? $_POST["buyr_tel1"] : "";      // 구매자 전화번호
    $buyr_tel2 = isset($_POST["buyr_tel2"]) ? $_POST["buyr_tel2"] : "";      // 구매자 휴대폰번호
    $buyr_mail = isset($_POST["buyr_mail"]) ? $_POST["buyr_mail"] : "";      // 구매자 E-Mail
    /* = -------------------------------------------------------------------------- = */
    // 신용카드
    $card_cd = isset($_POST["card_cd"]) ? $_POST["card_cd"] : "";      // 카드 코드
    $card_no = isset($_POST["card_no"]) ? $_POST["card_no"] : "";      // 카드 번호
    $card_name = isset($_POST["card_name"]) ? $_POST["card_name"] : "";      // 카드명
    $app_time = isset($_POST["app_time"]) ? $_POST["app_time"] : "";      // 승인시간 (공통)
    $app_no = isset($_POST["app_no"]) ? $_POST["app_no"] : "";      // 승인번호
    $quota = isset($_POST["quota"]) ? $_POST["quota"] : "";      // 할부개월
    $noinf = isset($_POST["noinf"]) ? $_POST["noinf"] : "";      // 무이자여부
    /* = -------------------------------------------------------------------------- = */
