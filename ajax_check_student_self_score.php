...
$Sql = "
	...
	where
		A.FranchiseID=1 and B.CenterID=:_LINK_MEMBER_CENTER_ID_
";
$Stmt = $DbConn->prepare($Sql);
$Stmt->bindParam(':_LINK_MEMBER_CENTER_ID_', $_LINK_MEMBER_CENTER_ID_);
$Stmt->execute();
...
if($MemberInviteID) {
	...
	InsertNewTypePoint(6, 0, $MemberInviteID, $InviteInfo);
}



// 수업에 학생이 입장한 시간을 입력해 준다.
$Sql = "UPDATE Classes 
			set StudentInTime = now() 
			where
				ClassID=$ClassID AND
				MemberID=$MemberID
			";
