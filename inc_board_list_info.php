	...
	<div id="bbs">
		...
		<ul class="Display">
			...
			while($Row = $Stmt->fetch()) {
				...
				$BoardFileName = "";
				$Sql2 = "select * from BoardContentFiles  where BoardContentID=:BoardContentID order by BoardFileNumber asc limit 0,1";
				$Stmt2 = $DbConn->prepare($Sql2);
				...
				while($Row2 = $Stmt2->fetch()){
					$BoardFileName = "./uploads/board_files/".$Row2["BoardFileName"];
				}
				$Stmt2 = null;
			...
			?>
			  <li>
				<a>
					<img src="<?=$BoardFileName?>" onerror="this.src='http://placehold.it/300X250'" class="img">
					<div class="txt">
