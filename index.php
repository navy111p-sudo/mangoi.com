...
<?
//==== 팝업 관련 =========================================== 
if ($DomainSiteID != 8 or $DomainSiteID != 9){ //engliseed.kr, live.engedu.kr 제외
    ...
    <div class="intro_area">
        <div class="intro_logo">
            ...
            <?}else if ($DomainSiteID==7){//gumiivyleague?>
				<img src="images/logo_gumiivyleague.png" class="logo_mangi_text" alt="로고">
            <?}else if ($DomainSiteID==8){//engliseed?>
                <img src="images/logo_engliseed.png" class="logo_mangi_text" alt="로고">
            <?}else if ($DomainSiteID==9){//live.engedu.kr?>
                <img src="images/eng-edu-logo.png" class="logo_mangi_text" alt="로고">
			<?}else{?>
				<img src="images/logo_mangi_text.png" class="logo_mangi_text" alt="로고">
			<?}?>
            <h4 class="intro_slogan">아이비리그어학원&유학센터</h4>
        </div>
        <ul class="intro_btns">
            
			<li id="BtnAppStore" style="display:none;margin-bottom:50px;"><a href="javascript:GoAppStore();" class="intro_go_btn bg"><img src="images/icon_intro_app.png" class="icon_intro" alt="로그인"><trn class="TrnTag">앱으로 학습하기</trn></a></li>
			
			<li><a href="javascript:CloseHomeIntro(0);" class="intro_go_btn"><img src="images/icon_intro_home.png" class="icon_intro" alt="메인화면"><trn class="TrnTag">메인화면 바로가기</trn></a></li>
            <li><a href="javascript:CloseHomeIntro(1);" class="intro_go_btn"><img src="images/icon_intro_login.png" class="icon_intro" alt="로그인"><trn class="TrnTag">로그인후 수업받기</trn></a></li>
        ...
        <div class="intro_area">
            <div class="intro_logo">
                ...
                <?}else{?>
                    <img src="images/logo_mangi_text.png" class="logo_mangi_text" alt="로고">
                <?}?>
                <h4 class="intro_slogan">잉글리씨드</h4>
            </div>
            <ul class="intro_btns">
                ...
                <li><a href="javascript:CloseHomeIntro(1);" class="intro_go_btn"><img src="images/icon_intro_login.png" class="icon_intro" alt="로그인"><trn class="TrnTag">로그인후 수업받기</trn></a></li>
                <br><br>
                <li><a href="javascript:OpenNewTabProManager();" class="intro_go_btn"><trn class="TrnTag">ProManger -PC</trn></a></li>
                <script>
                    function OpenNewTabProManager() {
                        window.open('https://engliseed.com/pm/main_program/engliseedProManager_v20.zip', '_blank');
                    }
                </script>

                <li><a href="javascript:OpenNewTabMultiplayer();" class="intro_go_btn"><trn class="TrnTag">Multiplayer 4.0 -PC</trn></a></li>
                <script>
                    function OpenNewTabMultiplayer() {
                        window.open('https://engliseed.com/pm/multiplayer40_m/multiPlayer(4.0).exe', '_blank');
                    }
                </script>


                <li><a href="javascript:OpenNewTabSeedpot();" class="intro_go_btn"><trn class="TrnTag">SEEDPOT -App</trn></a></li>
                <script>
                    function OpenNewTabSeedpot() {
                        window.open('https://edusoft.kr/shop/item.php?it_id=1561224430', '_blank');
                    }
                </script>

                <li><a href="javascript:OpenNewTab();" class="intro_go_btn"><trn class="TrnTag">WORDPOT -App</trn></a></li>
                <script>
                    function OpenNewTab() {
                        window.open('https://edusoft.kr/shop/item.php?it_id=1561224404', '_blank');
                    }
                </script>
        ...
        <div class="intro_area">
            <div class="intro_logo">
                ...
                <?}else{?>
                    <img src="images/logo_mangi_text.png" class="logo_mangi_text" alt="로고">
                <?}?>
                <h4 class="intro_slogan">이엔지 화상영어</h4>
            </div>
            <ul class="intro_btns">
        ...
        <div class="swiper-wrapper">
            <div class="swiper-slide first" style="background-image:url('images/main_visual_1.jpg')">
                <div class="main_visual_text first">
                    <h4 class="main_visual_small TrnTag">즐거운 화상영어</h4>
                    <h1 class="main_visual_big TrnTag">구미_아이비리그어학원<br> &유학센터</h1>
                    <div class="main_text TrnTag">아이비리그는 비교할 수 없는<br>특별함을 선물합니다.</div>
                </div>
            </div>
        ...
        <div class="swiper-container">
            <div class="swiper-wrapper">
                <div class="swiper-slide first" style="background-image:url('images/main_visual_1.jpg')">
                    <div class="main_visual_text first">
                        <h4 class="main_visual_small TrnTag">즐거운 화상영어</h4>
                        <h1 class="main_visual_big TrnTag">잉글리씨드</h1>
                        <div class="main_text TrnTag">잉글리씨드는 비교할 수 없는<br>특별함을 선물합니다.</div>
                    </div>
                </div>
                <div class="swiper-slide second" style="background-image:url('images/main_visual_2.jpg')">
                    <div class="main_visual_text second">
        ...
        <div class="swiper-container">
            <div class="swiper-wrapper">
                <div class="swiper-slide first" style="background-image:url('images/main_visual_1.jpg')">
                    <div class="main_visual_text first">
                        <h4 class="main_visual_small TrnTag">즐거운 화상영어</h4>
                        <h1 class="main_visual_big TrnTag">이엔지 화상영어</h1>
                        <div class="main_text TrnTag">이엔지 화상영어는 비교할 수 없는<br>특별함을 선물합니다.</div>
                    </div>
                </div>
                <div class="swiper-slide second" style="background-image:url('images/main_visual_2.jpg')">
                    <div class="main_visual_text second">
...
<?if ($DomainSiteID==7){ //gumiivyleague?>
<div class="main_wrap">    
    <!-- 레슨 비디오 영역 -->
    <section class="main_navi_wrap">
        <div class="main_navi_area">
			...
			<div class="main_navi_box">
				<h2 class="main_capiton TrnTag">특별한 화상영어 프로그램, <b>아이비리그</b></h2>
				<div class="main_caption_text TrnTag">엄마들의 주저 없는 선택 스마트한 엄마들의 절대적인 믿음</div>
				<ul class="main_navi_list gumiivyleague_main_navi_list">
					<li><a href="page.php?PageCode=mangoi"><img src="images/navi_main_1.gif" alt="화상영어란" class="img"></a></li>
					<li><a href="page.php?PageCode=mangoi#feature"><img src="images/navi_main_2_gumiivyleague.jpeg" alt="아이비리그특장점" class="img"></a></li>
    ...
    <section class="main_pc_wrap">
        <h2 class="main_capiton TrnTag">지금 바로 <b>아이비리그</b>를 만나보세요.</h2>
        <div class="main_caption_text TrnTag">원활한 아이비리그 화상영어를 위한 절차 및 안내입니다.</div>
        <ul class="main_pc_list">
            <li>
                ...
                <div class="main_pc_text TrnTag">아이비리그 화상영어<br>수강절차</div>
            ...
            <li>
                ...
                <div class="main_pc_text TrnTag">아이비리그에 궁금한 내용을<br>무엇이든 물어보세요</div>
    ...
    <section class="main_video_wrap">
        <h2 class="main_capiton TrnTag">지금 바로 <b>아이비리그</b>를 만나보세요.</h2>
        <div class="main_caption_text TrnTag" style="margin-bottom:0px">교재 + 레슨비디오 + 가이드를 통한 자연스러운 반복 학습의 효과</div>
    </section>
</div>
<?}else if ($DomainSiteID==8){ //engliseed?>
    <div class="main_wrap">
        ...
        <section class="main_navi_wrap">
            <div class="main_navi_area">
                ...
                <div class="main_navi_box">
                    <h2 class="main_capiton TrnTag">특별한 화상영어 프로그램, <b>잉글리씨드</b></h2>
                    <div class="main_caption_text TrnTag">엄마들의 주저 없는 선택 스마트한 엄마들의 절대적인 믿음</div>
                    <ul class="main_navi_list gumiivyleague_main_navi_list">
                        <li><a href="page.php?PageCode=mangoi"><img src="images/navi_main_1.gif" alt="화상영어란" class="img"></a></li>
                        <li><a href="page.php?PageCode=mangoi#feature"><img src="images/navi_main_2_engliseed.png" alt="잉글리씨드 특장점" class="img"></a></li>
                        <li><a href="page.php?PageCode=phi_center"><img src="images/navi_main_3.gif" alt="필리핀학습센터" class="img"></a></li>
                        <li><a href="page.php?PageCode=level"><img src="images/navi_main_4.gif" alt="교육과정" class="img"></a></li>
                        <li><a href="page.php?PageCode=payment"><img src="images/navi_main_5.gif" alt="수강신청" class="img"></a></li>
                        <li><a href="faq.php"><img src="images/navi_main_6.gif" alt="자주묻는질문" class="img"></a></li>
        ...
        <!-- PC 세팅 영역 -->
        <section class="main_pc_wrap">
            <h2 class="main_capiton TrnTag">지금 바로 <b>잉글리씨드</b>를 만나보세요.</h2>
            <div class="main_caption_text TrnTag">원활한 잉글리씨드 화상영어를 위한 절차 및 안내입니다.</div>
            <ul class="main_pc_list">
                <li>
                    <img src="images/icon_device_1.png" alt="수강절차" class="main_pc_img">
                    <span class="pc_line"></span>
                    <h3 class="TrnTag">수강절차</h3>
                    <div class="main_pc_text TrnTag">잉글리씨드 화상영어<br>수강절차</div>
                    <a href="page.php?PageCode=course" class="main_pc_btn TrnTag">바로가기 <img src="images/arrow_go.png" alt="바로가기"></a>
                </li>
                <li>
                    <img src="images/icon_device_2.png" alt="1:1 문의" class="main_pc_img">
                ...
                <li>
                    ...
                    <span class="pc_line"></span>
                    <h3 class="TrnTag">묻고 답하기</h3>
                    <div class="main_pc_text TrnTag">잉글리씨드에 궁금한 내용을<br>무엇이든 물어보세요</div>
                    <a href="board_list.php?BoardCode=qna" class="main_pc_btn TrnTag">바로가기 <img src="images/arrow_go.png" alt="바로가기"></a>
                </li>
                <li>
                    <img src="images/icon_device_4.png" alt="PC 원격지원" class="main_pc_img">
                    <span class="pc_line"></span>
                    <h3 class="TrnTag">PC 원격지원</h3>
                    <div class="main_pc_text TrnTag">설치가 제대로 되지 않았다면<br>PC 원격지원을 신청해 주세요</div>
                    <a href="remote_support.php" class="main_pc_btn TrnTag">바로가기 <img src="images/arrow_go.png" alt="바로가기"></a>
                </li>
            </ul>
        </section>
    ...
    <div class="main_wrap">
        ...
        <section class="main_navi_wrap">
            <div class="main_navi_area">
                ...
                <div class="main_navi_box">
                    <h2 class="main_capiton TrnTag">특별한 화상영어 프로그램, <b>이엔지 화상영어</b></h2>
                    <div class="main_caption_text TrnTag">엄마들의 주저 없는 선택 스마트한 엄마들의 절대적인 믿음</div>
                    <ul class="main_navi_list gumiivyleague_main_navi_list">
                        <li><a href="page.php?PageCode=mangoi"><img src="images/navi_main_1.gif" alt="화상영어란" class="img"></a></li>
                        <li><a href="page.php?PageCode=mangoi#feature"><img src="images/navi_main_2_engedu.png" alt="이엔지 화상영어 특장점" class="img"></a></li>
                        <li><a href="page.php?PageCode=phi_center"><img src="images/navi_main_3.gif" alt="필리핀학습센터" class="img"></a></li>
                        <li><a href="page.php?PageCode=level"><img src="images/navi_main_4.gif" alt="교육과정" class="img"></a></li>
                        <li><a href="page.php?PageCode=payment"><img src="images/navi_main_5.gif" alt="수강신청" class="img"></a></li>
                        <li><a href="faq.php"><img src="images/navi_main_6.gif" alt="자주묻는질문" class="img"></a></li>
        ...
        <!-- PC 세팅 영역 -->
        <section class="main_pc_wrap">
            <h2 class="main_capiton TrnTag">지금 바로 <b>이엔지 화상영어</b>를 만나보세요.</h2>
            <div class="main_caption_text TrnTag">원활한 이엔지 화상영어를 위한 절차 및 안내입니다.</div>
            <ul class="main_pc_list">
                <li>
                    <img src="images/icon_device_1.png" alt="수강절차" class="main_pc_img">
                    <span class="pc_line"></span>
                    <h3 class="TrnTag">수강절차</h3>
                    <div class="main_pc_text TrnTag">이엔지 화상영어<br>수강절차</div>
                    <a href="page.php?PageCode=course" class="main_pc_btn TrnTag">바로가기 <img src="images/arrow_go.png" alt="바로가기"></a>
                </li>
                <li>
                    <img src="images/icon_device_2.png" alt="1:1 문의" class="main_pc_img">
                ...
                <li>
                    ...
                    <span class="pc_line"></span>
                    <h3 class="TrnTag">묻고 답하기</h3>
                    <div class="main_pc_text TrnTag">이엔지 화상영어에 궁금한 내용을<br>무엇이든 물어보세요</div>
                    <a href="board_list.php?BoardCode=qna" class="main_pc_btn TrnTag">바로가기 <img src="images/arrow_go.png" alt="바로가기"></a>
                </li>
                <li>
                    <img src="images/icon_device_4.png" alt="PC 원격지원" class="main_pc_img">
    ...
    <section class="main_video_wrap">
        ...
        <div class="main_video_area">
            ...
            <div class="main_video_right">
                <iframe class="main_video_iframe" src="https://www.youtube.com/embed/OC-Q0c0dRPw" frameborder="0" gesture="media" allowfullscreen></iframe>
            </div>
        </div>
    </section>
</div>
...
<!----- 모바일 레이어 팝업------->
<?php
if ($DomainSiteID != 8 or $DomainSiteID != 9) { //engedu.kr, live.engedu.kr 제외
