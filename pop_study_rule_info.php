...
?>
    <section class="app_class_wrap pop" style="margin-top:20px;">
        <div class="app_class_area guide">
                ...
                <ul class="class_guide_list">
                    ...
                    <li class="table">
                        <table class="class_guide_list_table three">
                            <th class="TrnTag">수업 스케쥴 :</th>
                            <td class="TrnTag">오전반(07시 ~ 14시, 월~금요일) / 오후반(15시 ~ 23시, 월 ~ 금요일)</td>
                        </table>
                    </li>
                    <li class="table">
                        <table class="class_guide_list_table four">
                            <th class="TrnTag">주 2회~5회 가능 :</th>
            ...
            <ul class="class_guide_list one">
                <li class="TrnTag">고정예약 수업연기는 제한이 있습니다.<br>(주1회 ~ 주2회 수업 1회, 주3회 ~5회 수업 2회)<br>ex) 주5회 수업 일정이 3/19 ~ 4/13 한달 20회가 등록되시면 그 기간 동안 연기는 2번만 가능합니다.</li>
            </ul>

            <ul class="class_guide_list two">
                <li class="TrnTag">수업연기요청은 수업시작 30분전까지 교사의 공강 여부에 따라 가능합니다.</li>
            ...
            <h4 class="class_rule_caption orange TrnTag">고정 수업 가이드</h4>
            <ul class="class_rule_list">
                <li class="TrnTag"><span>01.</span> 수강료 결제를 완료하시면 24시간 내에 학습매니저가 회원님에게 전화를 드려 강사와 시간 등에 대한 스케쥴을 잡아 수강등록을 해드립니다.</li>
                <li class="TrnTag"><span>02.</span> 수업스테쥴이 잡히면 바로 수강하실 수 있으며, 교재 구입전이라도 온라인상의 샘플교재를 이용하여 수강하실 수 있습니다.</li>
                <li class="TrnTag"><span>03.</span> 주3회 수업은 월, 수, 금요일에 주2회 수업은 화, 목요일에 이루어 집니다.</li>
                <li class="TrnTag"><span>04.</span> 수강기간은 횟수로 정해집니다. (1개월 수업의 경우 주5회는 20회 수업, 주3회 수업은 12회 수업, 주2회 수업은 8회 수업)</li>
            </ul>

            <h4 class="class_rule_caption orange TrnTag">일일 수업 연기</h4>
            <ul class="class_rule_list">
            ...
            <h4 class="class_rule_caption orange TrnTag">수업 시간 변경</h4>
            <ul class="class_rule_list">
                <li class="TrnTag"><span>01.</span> 수업시간을 변경하고자 하는 경우에는 어플에서 연기신청을 눌러서 교사 또는 수업 시간 둘 중 선택 가능합니다.</li>
                <li class="TrnTag"><span>02.</span> 수업시간을 변경하시면 담당강사가 변결될 수 있으며, 변경신청 시 유념하시기 바랍니다.</li>
                <li class="TrnTag"><span>03.</span> 수업시간 변경은 전체 월 수업시간의 ½회 가능합니다.</li>
            </ul>

            <h4 class="class_rule_caption orange TrnTag">담당 강사 변경</h4>
            <ul class="class_rule_list">
            ...
            <h4 class="class_rule_caption orange TrnTag">결석 처리 안내</h4>
            <ul class="class_rule_list">
                ...
                <li class="TrnTag"><span>03.</span> 수강생의 과실로 인한 결석은 별도의 보강이 제공되지 않습니다.</li>
                <li class="TrnTag"><span>04.</span> 수강생의 사정으로 인해 수업시작이 지연된 경우에는 수업시간을 채우지 못했다 할지라도 예정된 종료시간에 수업이 종료됩니다.<br>(뒤이어 예약된 학생의 수업에 지장을 끼칠 우려가 있으므로 불가피함)</li>
            </ul>
