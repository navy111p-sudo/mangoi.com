...
$Sql2 = "select 
		...
		order by A.EventStartDate desc, A.EventEndDate desc";
$Stmt2 = $DbConn->prepare($Sql2);
//$Stmt2->bindParam(':SubCode', $SubCode);
$Stmt2->execute();
...
<div class="sub_wrap bg_gray">
    ...
    <div class="sub_title_common_wrap"><h2 class="sub_title_common"><b class="TrnTag">이벤트</b></h2></div>  
        ...
        <div class="event_area">
			...
			<?php
				while($Row2 = $Stmt2->fetch()) {
					...
					$EventContentSummary = $Row2["EventContentSummary"];
			...
			?>
                <li>
					<a href="event_read.php?EventID=<?=$EventID?>">
                        <div class="event_img" style="background-image:url(./uploads/event_images/<?=$EventImageFileName?>)"></div>
                        <div class="event_right">
                            <div class="text_right"><?=$EventStatus?></div>
                            <h3 class="event_caption ellipsis"><?=$EventTitle?></h3>
                            <div class="event_text"><?=$EventContentSummary?></div>
                            <div class="event_date"><?=$StrEventRegDateTime?></div>
                        </div>
                    </a>
                </li>
			<?php } ?>	
