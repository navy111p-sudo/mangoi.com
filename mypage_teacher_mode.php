    ...
    <section class="mypage_teacher_wrap">
        <div class="mypage_teacher_area">
            <div class="mypage_teacher_mode_box">
				...
				-->
                <div class="mypage_teacher_mode_wait">대기중입니다.</div><br>
				<!--<?php } ?>-->

				<div class="button_wrap text_center" style="padding:0 0 20px 0;"><a type="button" href="javascript:OpenUpLoginPopUp(<?=$CenterID?>)" class="button_whtie_border_arrow_2">로그인</a></div>
            </div>
        </div>
    </section>
</div>
...
function OpenUpLoginPopUp(CenterID) {
	openurl = "pop_mypage_teacher_mode_login.php?CenterID="+CenterID;
