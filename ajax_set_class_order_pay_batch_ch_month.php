...
$ClassOrderPayBatchMonth = isset($_REQUEST["ClassOrderPayBatchMonth"]) ? $_REQUEST["ClassOrderPayBatchMonth"] : "";
$MemberID = $_LINK_MEMBER_ID_;


//=========================================================================================
$Sql = " update ClassOrderPayBatchs set ";
$Sql .= "	ClassOrderPayBatchMonth=:ClassOrderPayBatchMonth, ";
$Sql .= "	ClassOrderPayBatchModiDateTime=now() ";
$Sql .= " where ClassOrderPayBatchID=:ClassOrderPayBatchID ";

$Stmt = $DbConn->prepare($Sql);
$Stmt->bindParam(':ClassOrderPayBatchMonth', $ClassOrderPayBatchMonth);
