...
$Sql = "select * from ClassOrderPays_test where ClassOrderPayNumber=:OrderNumPay and PayResultCd='0000' ";
$Stmt = $DbConn->prepare($Sql);
...
echo "1111";
	...
	// 로그 남기기 =======================
	$Sql_Log = " update ClassOrderPays_test set ";
...
echo "2222";
	/* 실행 안하기 - 셀프페이 재전송 ClassOrderPays_test*/
	$Sql = " update ClassOrderPays_test set ";
	...
	if ($PayResultCd == "0000"){
		...
		$Sql = "select * from ClassOrderPays_test where ClassOrderPayNumber=:ClassOrderPayNumber";
		$Stmt = $DbConn->prepare($Sql);
		...
		*/
		...
		/* 실행 안하기 - 셀프페이 재전송 ClassOrderPays_test*/
		$Sql2 = "update ClassOrderPays_test set ClassOrderPayStartDate=:ClassOrderPayStartDate where ClassOrderPayNumber=:ClassOrderPayNumber";
		$Stmt2 = $DbConn->prepare($Sql2);
