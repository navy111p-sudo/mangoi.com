...
<div class="sub_wrap">
    ...
    <div class="sub_title_common_wrap"><h2 class="sub_title_common TrnTag"><b>비밀번호</b> 찾기</h2></div>  
        ...
        <div class="idpw_area">
            ...
            <form name="RegForm" method="post">
                <table class="idpw_table">
                    ...
                    <tr>
                        <th class="TrnTag">아이디</th>
                        <td><input type="text" name="MemberLoginID" class="input_idpw"></td>
                    </tr>
                    <tr>
...
<style>
/** 아디/비번 찾기 탭메뉴 **/
.tab_idpw li.one{border-left:1px solid #e3e3e3;}
.tab_idpw li.two{border:0; border:2px solid #333; border-bottom:0; position:relative; line-height:39px;}
.tab_idpw li.two:after{content:''; position:absolute; background-color:#fff; bottom:-1px; left:0; right:0; height:1px;}

@media all and (min-width:640px){
.tab_idpw li.two{line-height:43px;}
}
@media all and (min-width:768px){
.tab_idpw li.two{line-height:43px;}
}
@media all and (min-width:1024px){
.tab_idpw li.two{line-height:48px;}
}
...
function FormSubmit(){
	...
	document.RegForm.action = "search_pw_action.php";
