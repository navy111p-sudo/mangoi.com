...
function send_notification ($token, $title, $message){
	...
	echo "send_notification / ". $token ." / ".$title." / ".$message . "<br>";
...
$Sql = "select 
		...
		where 
			A.PushMessageState=1 and A.UseSendPush=1 and timestampdiff(second, A.SendMessageDateTime, now())>=0 and datediff(A.SendMessageDateTime, now())=0 
...
function MunjaSend($OnlineSiteID, $SendTitle, $SendMessage, $SmsMessagePhoneNumber){
	...
	echo "MunjaSend / ". $OnlineSiteID ." / ".$SendTitle." / ".$SendMessage." / ".$SmsMessagePhoneNumber . "<br>";
...
function MunjaSend2($OnlineSiteID, $SendTitle, $SendMessage, $SmsMessagePhoneNumber){
	...
	echo "MunjaSend2 / ". $OnlineSiteID ." / ".$SendTitle." / ".$SendMessage." / ".$SmsMessagePhoneNumber . "<br>";
