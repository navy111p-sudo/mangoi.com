...
<div class="mypage_top_wrap">
	<div class="mypage_top_left">
		...
		<div class="mypage_info">
			...
			<div class="mypage_join"><?=$MemberRegDateTime?>부터 <?if ($DomainSiteID==5){?>English Tell과<?}else{?>망고아이와<?}?> 함께 하고 있습니다.</div>
	...
	<div class="mypage_top_right">
		...
		<ul class="mypage_today_btns">
			<?if ($HideLinkBtn==0) {?>
			<li style="width:100%;"><a href="mypage_study_room.php" class="button_yellow_black" >공부방입장</a></li>
