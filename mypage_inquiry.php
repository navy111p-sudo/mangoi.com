...
<div class="sub_wrap">       
    <div class="sub_title_common_wrap"><h2 class="sub_title_common TrnTag"><b>1:1</b> 문의</h2></div>
    ...
    <section class="mantoman_wrap">
        <div class="mantoman_area">
            ...
            <div class="">
                ...
                <h3 class="caption_left_common_span TrnTag">나의 <b>상담이력</b><span>Total : <b><?=$Row3['count']?></b></span></h3>
