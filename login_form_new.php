...
<div class="sub_wrap">       
    ...
    <section class="login_wrap">
        <div class="login_area">
            ...
            <div class="login_caption_text">Welcome 망고아이에 오신 것을 환영합니다.</div>
			<form name="LoginForm" method="post" class="pt-30 pb-30">
				...
				<a href="javascript:FormSubmit();" class="login_btn">로그인</a>
			
				<div class="login_bottom">
					<div class="login_save check_wrap"><input type="checkbox" id="ApplyRememberID" class="input_check" name="ApplyRememberID" <?php if (isset($_COOKIE["RememberMemberID"])){ ?>checked<?php }?>><label class="label" for="ApplyRememberID"><span class="bullet_check"></span>로그인 상태유지</label></div>
					<ul class="login_navi">
                ...
                <ul class="login_link">
                    ...
                    <li>
                        <a id="naverIdLogin" href="#" role="button"><img src="images/btn_naver.png" class="btn_naver"></a>
                    </li>
                </ul>
				-->
			</form>
...
<script type="text/javascript">
	function onSignIn(googleUser) {
		...
		console.log(profile);
		//var url = "check_sns_account.php?Id="+Id+"&Email="+Email+"&Name="+Name+"&Type=3";
		//location.href = url;
	}
...
<script type="text/javascript">
	var naverLogin = new naver.LoginWithNaverId(
		{
			clientId: "CoQbcFgHY1wX7ZGMLu9y",
			callbackUrl: "http://mangoidev.hihome.kr/login_form_naver.php",
			//callbackUrl: "http://mangoidev.hihome.kr/check_naver_account.php",
			isPopup: true,
	...
	Kakao.Auth.loginForm({
		success: function(authObj) {
			Kakao.Auth.getStatusInfo(function callback(statusObj) {
				...
				KakaoCheckAccount(KakaoId, KakaoEmail, KakaoName);
			});
		},
		fail: function(err) {
			alert("로그인에 실패하였습니다.");
...
function KakaoCheckAccount(Id, Email, Name) {
	//var url = "ajax_check_kakao_account.php";
	var url = "check_sns_account.php?Id="+Id+"&Email="+Email+"&Name="+Name+"&Type=1";
	location.href = url;
}
