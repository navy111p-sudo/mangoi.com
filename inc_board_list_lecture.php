...
$SearchMemberID = isset($_REQUEST["SearchMemberID"]) ? $_REQUEST["SearchMemberID"] : "";
...
if ($SearchMemberID!=""){
	$AddSqlWhere = $AddSqlWhere . " and A.BoardContentMemberID='$SearchMemberID' ";
	$ListParam = $ListParam . "&SearchMemberID=$SearchMemberID";
}		
