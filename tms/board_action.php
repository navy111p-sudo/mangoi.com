...
$BoardContentMain = isset($_REQUEST["BoardContentMain"]) ? $_REQUEST["BoardContentMain"] : "";
...
$BoardContentVideoCode = isset($_REQUEST["BoardContentVideoCode"]) ? $_REQUEST["BoardContentVideoCode"] : "";
...
if ($NewData=="1"){
	...
	$Sql = " insert into BoardContents ( ";
		...
		$Sql .= " BoardContentMain, ";
		$Sql .= " BoardContentSubject, ";
		$Sql .= " BoardContent, ";
		$Sql .= " BoardContentTag, ";
		$Sql .= " BoardContentSecret, ";
		$Sql .= " BoardContentVideoCode, ";
	...
	$Stmt->bindParam(':BoardContentMain', $BoardContentMain);
	...
	$Stmt->bindParam(':BoardContentVideoCode', $BoardContentVideoCode);
	$Stmt->bindParam(':BoardContentReplyID', $BoardContentReplyID);
	$Stmt->bindParam(':BoardContentReplyOrder', $BoardContentReplyOrder);
	...
	$Sql = " update BoardContents set ";
		...
		$Sql .= " BoardContentMain = :BoardContentMain, ";
		...
		$Sql .= " BoardContentVideoCode = :BoardContentVideoCode, ";
