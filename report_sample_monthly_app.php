...
?>
    <div class="report_wrap">
        <h1 class="report_month_caption">
			...
			<trn class="TrnTag">정기평가보고서</trn> <?=$AssmtStudentMonthlyScoreYear?>.<?=substr("0".$AssmtStudentMonthlyScoreMonth,-2)?>
        </h1>
            ...
            <div class="report_top_left">
                ...
                <table class="report_table">
                    ...
                    <tr>
                        ...
                        <td class="bg_green_2"><b><?=$AttendClassTime?>min</b></td>
                    </tr>
                </table>
            </div>
            <div class="report_top_right">
                ...
                <table class="report_table">
                    ...
                    <tr>
                        ...
                        <td class="bg_pink_2"><b><?=$AssmtStudentMonthlyScoreLevel?></b></td>
                    </tr>
                </table>
            </div>
        </div>
        ...
        <div class="report_chart_wrap">
			...
			<div style="line-height:1.5;"><span style="color:#69B7DA;">■</span> 나의 점수 <span style="color:#6894D9;">■</span> 평균</div>
