...
<div class="sub_wrap">       
    ...
    <section class="member_wrap">
        <div class="member_area">           
			...
			<?}else{?>
			 <h2 class="member_caption TrnTag">회원<span class="normal">가입</span></h2>
			<?}?>
			...
			<form name="RegForm" method="post" class="pt-30 pb-40" autocomplete="off">
				...
				<h3 class="member_join_caption TrnTag">기본정보<span><b class="member_red">★</b> 표시는 필수 입력사항입니다.</span></h3>
				<table class="member_table">
					...
					<tr>
						...
						<td>
							<input type="email" name="MemberLoginID" id="MemberLoginID" class="member_id" onkeyup="EnNewID()" style="ime-mode:disabled;">
							<a href="javascript:CheckID()" class="member_btn_confirm TrnTag" id="BtnCheckID">중복확인</a>
							<div class="member_idpw_text TrnTag">영문, 숫자, _만 가능, 4글자 이상</div>
						</td>
					</tr>
					<?
					}else{
            ...
            <table class="member_table">
                <tr>
                    <th class="TrnTag">한글성명 <b class="member_red">★</b></th>
				...
				<tr>
					...
					<td class="radio_wrap teacher">
                        <input type="radio" id="teacher_1" class="input_radio" checked name="MemberSex" value="1" <?if ($MemberSex==1) {?>checked<?}?>><label class="label" for="teacher_1"><span class="bullet_radio"></span>남자</label>
                        <input type="radio" id="teacher_2" class="input_radio" name="MemberSex" value="2" <?if ($MemberSex==2) {?>checked<?}?>><label class="label" for="teacher_2"><span class="bullet_radio"></span>여자</label>
                    </td>
				</tr> 
                <tr>
                ...
                <tr>
                    <th class="TrnTag">이메일 <b class="member_red">★</b></th>
                    <td>
						...
						<a href="javascript:CheckEmail()" class="member_btn_confirm email TrnTag" id="BtnCheckID2" style="display:<?if ($MemberID=="") {?><?}else{?>none<?}?>">중복확인</a>
                        <div class="member_idpw_text check_wrap agree" style="display:none;"><input type="checkbox" id="MemberEmailAgree" class="input_check" value="1" <?if ($MemberEmailAgree==1) {?>checked<?}?> name="MemberEmailAgree"><label class="label" for="MemberEmailAgree TrnTag"><span class="bullet_check"></span>이메일 수신동의</label></div>
                ...
                <tr style="display:<?if ($MemberID!="") {?>none<?}?>;">
                    <th>추천인ID</th>
                    <td>
						<?
						if($MemberInviteID!="") {
						...
						<a href="javascript:SearchInviteMember();" class="member_btn_confirm TrnTag">검색</a>
            ...
            <h3 class="member_join_caption TrnTag" style="display:">수업정보, 상담정보, 기타 부가정보</h3>
			<table class="member_table" style="display:">
				<tr>
					...
					<td>
						...
						<div class="radio_wrap alram">
							<input type="radio" id="MemberStudyAlarmType_1" class="input_radio" value="1" name="MemberStudyAlarmType" <?if ($MemberStudyAlarmType==1){?>checked<?}?>><label class="label" for="MemberStudyAlarmType_1"><span class="bullet_radio TrnTag"></span>수신</label>
							<input type="radio" id="MemberStudyAlarmType_2" class="input_radio" value="2" name="MemberStudyAlarmType" <?if ($MemberStudyAlarmType==2){?>checked<?}?>><label class="label" for="MemberStudyAlarmType_2"><span class="bullet_radio TrnTag"></span>거부</label>
						</div>
					</td>
				</tr>
				<tr>
					...
					<td class="radio_wrap teacher">
						<input type="radio" id="MemberChangeTeacher_1" class="input_radio" value="1" name="MemberChangeTeacher" <?if ($MemberChangeTeacher==1){?>checked<?}?>><label class="label TrnTag" for="MemberChangeTeacher_1"><span class="bullet_radio TrnTag"></span>다른 강사로 대체</label>
						<input type="radio" id="MemberChangeTeacher_2" class="input_radio" value="2" name="MemberChangeTeacher" <?if ($MemberChangeTeacher==2){?>checked<?}?>><label class="label TrnTag" for="MemberChangeTeacher_2"><span class="bullet_radio TrnTag"></span>강사 대체없이 수업 취소</label>
					</td>
				</tr>
				<!--
				<tr>
