					...
					?>
						...
						$Sql2_ViewTable = "
							...
							where 
									...
									and ( 
											(AAAA.ClassOrderSlotType=1 and AAAA.StudyTimeWeek=".$SelectWeek." and AAAA.ClassOrderSlotStartDate is NULL and AAAA.ClassOrderSlotEndDate is NULL and datediff(BBBB.ClassOrderStartDate, '".$SelectDate."')<=0 ) 

											or 
											(AAAA.ClassOrderSlotType=1 and AAAA.StudyTimeWeek=".$SelectWeek." and datediff(AAAA.ClassOrderSlotStartDate, '".$SelectDate."')<=0 and AAAA.ClassOrderSlotEndDate is NULL and datediff(BBBB.ClassOrderStartDate, '".$SelectDate."')<=0 ) 

											or 
											(AAAA.ClassOrderSlotType=1 and AAAA.StudyTimeWeek=".$SelectWeek." and AAAA.ClassOrderSlotStartDate is NULL and datediff(AAAA.ClassOrderSlotEndDate, '".$SelectDate."')>=0 and datediff(BBBB.ClassOrderStartDate, '".$SelectDate."')<=0 ) 

											or 
											(AAAA.ClassOrderSlotType=1 and AAAA.StudyTimeWeek=".$SelectWeek." and datediff(AAAA.ClassOrderSlotStartDate, '".$SelectDate."')<=0 and datediff(AAAA.ClassOrderSlotEndDate, '".$SelectDate."')>=0 and datediff(BBBB.ClassOrderStartDate, '".$SelectDate."')<=0 ) 
