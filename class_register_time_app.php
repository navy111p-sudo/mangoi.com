    ...
    <section class="mypage_wrap">
        <div class="mypage_area">
            ...
            <ul class="class_register_tab">
                <li><a href="class_register_teacher_app.php" class="TrnTag"><span class="register_img_1"></span>강사 먼저 선택</a></li>
                <li><a href="class_register_time_app.php" class="active TrnTag"><span class="register_img_2"></span>날짜 먼저 선택</a></li>
            </ul>
            ...
            <div class="mypage_inner">
				...
				<ul class="class_keyword_list noborder">
                    <li class="class_keyword_caption TrnTag">수강 시작일</li>                    
                ...
                <div class="class_days_wrap">
                    <h4 class="class_days_caption">수업 요일</h4>
				...
				function GetTeacherList(SetType){
					if (SetType==0){
						...
						if (ClassWeekNum_1=="1" && ClassStudyTime_1==""){
							$.alert({title: "안내", content: "월요일 수강시간을 선택하세요."});
						}else if (ClassWeekNum_2=="1" && ClassStudyTime_2==""){
							$.alert({title: "안내", content: "화요일 수강시간을 선택하세요."});
						}else if (ClassWeekNum_3=="1" && ClassStudyTime_3==""){
							$.alert({title: "안내", content: "수요일 수강시간을 선택하세요."});
						}else if (ClassWeekNum_4=="1" && ClassStudyTime_4==""){
							$.alert({title: "안내", content: "목요일 수강시간을 선택하세요."});
						}else if (ClassWeekNum_5=="1" && ClassStudyTime_5==""){
							$.alert({title: "안내", content: "금요일 수강시간을 선택하세요."});
						}else{
				...
				function ClassOrderSubmit(TeacherID, TeacherPayTypeItemID, SelectSlotCode, SelectStudyTimeCode){
					...
					if (SelectSlotCode=="" || SelectStudyTimeCode==""){
						$.alert({title: "안내", content: "요일과 시간을 선택해 주세요."});
					}else{
