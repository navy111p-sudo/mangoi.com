...
?>
	...
	<div id="bbs">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0" class="TbWriteTop">
		  ...
		  ?>
		  <tr>
			<th class="TrnTag">공지사항</th>
			<td colspan="2" class="br_bottom title"><input type="checkbox" name="BoardContentNotice" value="1" <?php if ($BoardContentNotice==1) {echo ("checked");}?> style="width:15px;"> <trn class="TrnTag">공지로 등록</trn></td>
		  </tr>
		  <?php
		  }
		  ?>
		  ...
		  ?>
		  <tr>
			<th class="TrnTag">비밀글</th>
			<td colspan="2" class="br_bottom"><input type="checkbox" name="BoardContentSecret" value="1" <?php if ($BoardContentSecret==1) {echo ("checked");}?> style="width:15px;"> <trn class="TrnTag">비밀글로 등록</trn></td>
		  </tr>
		  <?php
		  }
		  ?>
		  ...
		  <tr>
			...
			<td colspan="2">
						...
						<input type="file" id="file"  class="File" name="BoardFile<?=$FileID?>" style="margin:3px 0; width:200px;display:inline-block;">
							...
							if ($BoardFileID!=""){
							?>
							<input type="checkbox" name="DelBoardFile<?=$FileID?>" value="1" style=" width:14px; height:14px; vertical-align:-2px;"> <trn class="TrnTag">삭제</trn>
							<?php
							}
							?>	
                            </li>
        ...
        <div class="BtnCenter">
            <a href="javascript:FormSubmit();" class="BtnGray TrnTag">등 록</a>
            <a href="board_list.php?BoardCode=<?=$BoardCode?>" class="BtnGray TrnTag">목 록</a>
        </div>
	</div>
