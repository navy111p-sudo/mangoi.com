...
if ($ClassOrderMode=="LMS"){
	...
	$ClassOrderPayNumber = "MH".date("YmdHis").substr("0000000000".$MemberID,-10); // ML -> Mangoi Home
}
//=========================================================================================
...
$Sql = "
		...
		where A.ClassOrderID=$ClassOrderID and A.ClassOrderSlotType=1 and A.ClassOrderSlotEndDate is null and A.ClassOrderSlotState=1 AND A.ClassOrderSlotDate IS NULL 
