...
<section class=\"mypage_start_area\">
	<ul class=\"mypage_tabs\">
		<li><a href=\"#\" class=\"active TrnTag\"><span class=\"bar\"></span>마이 페이지</a></li>
		<li><a href=\"mypage_study_room.html\" class=\"item-link item-content TrnTag\"><span class=\"bar\"></span>나의 공부방</a></li>
		<li><a href=\"mypage_study_history.html\" class=\"item-link item-content TrnTag\"><span class=\"bar\"></span>학습 이력</a></li>
	</ul>
	<section class=\"study_today_area\">
		...
		<div class=\"study_today_right\">
			...
			<small class=\"study_today_time\">".$MemberRegDateTime."<trn class='TrnTag'>부터 특별한 망고아이와 함께 하고 있습니다.</trn></small>
			<div class=\"study_today_point\"><trn class='TrnTag'>나의 포인트</trn> <b>".number_format($MemberPoint,0)."P</b></div>
			<div class=\"study_today_chart_wrap\">
				<div class=\"study_today_btns\">
					<a href=\"mypage_study_history.html\" class=\"item-link item-content study_today_btn yellow TrnTag\">학습이력</a>
					<a href=\"#\" class=\"item-link item-content open-popup study_today_btn blue TrnTag\" data-popup=\".popup-point-list\">포인트내역</a>
					<a href=\"#\" class=\"item-link item-content open-popup study_today_btn pink TrnTag\" data-popup=\".popup-payment-list\">결제내역</a>
				</div>
			</div>
			<a href=\"mypage_study_room.html\" class=\"my_enter_btn item-link item-content TrnTag\"><img src=\"images/icon_write_yellow.png\" class=\"icon\"><br>나의 공부방<br>입장하기</a>
		</div>
	</section>
	...
	<table class=\"study_month_banner\">
		<tr>
			<td class=\"study_month_left\">
				...
				<div class=\"study_month_inner TrnTag\"><h3>나의 공부방 입장하기</h3>망고아이와 특별한 경험을 체험하세요!</div>
			</td>
	...
	<h3 class=\"caption_center_underline TrnTag\">최근학습 <b>평가결과</b></h3>
	<div class=\"study_result\">
		...
		<table class=\"study_result_table\">
			...
			<col width=\"23%\">
			<tr>
				<th class=\"th_yellow TrnTag\">날짜</th>
				<th class=\"th_yellow TrnTag\">말하기</th>
				<th class=\"th_yellow TrnTag\">듣기</th>
				<th class=\"th_yellow TrnTag\">참여도</th>
			</tr>";
...
$PageMyPageHTML .= "
			<tr>
				<th class=\"th_gray_1 TrnTag\">합계</th>
			...
			<tr>
				<th class=\"th_gray_2 TrnTag\">평균</th>
