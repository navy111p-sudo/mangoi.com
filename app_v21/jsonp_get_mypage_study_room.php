...
$PageMyPageRoomHTML .= " 
		<div style=\"display:inline-block;width:49%;text-align:left;\">
			<li><a href=\"#\" onclick=\"OpenLessonVideos();\" class=\"color_review_book TrnTag\" style=\"padding:2px 10px;\">전체레슨비디오</a></li>
		</div>
		<div style=\"display:inline-block;width:49%;text-align:right;\">
			<li><a href=\"report_monthly_list.html\" class=\"color_review_book TrnTag\" style=\"padding:2px 10px;background-color:#005E8A;\">정기평가보고서</a></li>
		</div>
";
					...
					if ($CurrentDateType==0 || $CurrentDateType>0){
						...
						if ($ClassID==0){
							if ($ClassMemberType==1){// 1:1 수업
								if ($MemberID==13591) {
									$PageMyPageRoomHTML .= "<li id=\"BtnResetDate\" style=\"width:100%;\"><a class=\"color_postpone TrnTag\">수업연기요청</a></li>";
								} else {
								...
								if ($MemberID==13591) {
									...
									$PageMyPageRoomHTML .= "<li id=\"BtnResetDate\" style=\"width:100%;\"><a href=\"#\" onclick=\"OpenResetDateFormErr();\" class=\"color_postpone TrnTag\">수업연기요청</a></li>";
								}
							}
						}else{
							if ($ClassAttendState==4 || $ClassAttendState==5 || $ClassAttendState==6 || $ClassAttendState==7 || $ClassAttendState==8 || $ClassState==2){
								...
								if ($ClassMemberType==1){// 1:1 수업
									if ($MemberID==13591) {
										...
										$PageMyPageRoomHTML .= "<li id=\"BtnResetDate\" style=\"width:100%;\"><a href=\"#\" onclick=\"OpenResetDateForm(".$ClassID.", ".$ClassProductID.", ".(int)$StudyTimeHour.", ".(int)$StudyTimeMinute.");\" class=\"color_postpone TrnTag\">수업연기요청</a></li>";
									}
								}else{
									if ($MemberID==13591) {
										$PageMyPageRoomHTML .= "<li id=\"BtnResetDate\" style=\"width:100%;\"><a class=\"color_postpone TrnTag\">수업연기요청</a></li>";
