...
<section class=\"class_register_area\">
	<ul class=\"class_register_tabs\">
		<li><a href=\"#\" class=\"active TrnTag\"><span class=\"bar\"></span>강사 먼저 선택</a></li>
		<li><a href=\"class_register_date.html\" class=\"item-link item-content TrnTag\"><span class=\"bar\"></span>날짜 먼저 선택</a></li>
	</ul>
	...
	<ul class=\"class_keyword_list\">
		<li class=\"class_keyword_caption TrnTag\">성별 선택</li>
		<li class='TrnTag'>남자</li>
		<li class=\"active TrnTag\">여자</li>
		<li class='TrnTag'>상관없음</li>
	</ul>

	<ul class=\"class_keyword_list noborder\">
		<li class=\"class_keyword_caption TrnTag\">성향 선택</li>
		<li class='TrnTag'>진지한</li>
		<li class='TrnTag'>실력있는</li>
		<li class='TrnTag'>큰 목소리</li>
		<li class='TrnTag'>낙관적</li>
		<li class=\"active TrnTag\">적극적</li>
		<li class='TrnTag'>사교적</li>
		<li class='TrnTag'>개방적</li>
		<li class='TrnTag'>조용한</li>
		<li class='TrnTag'>사려 깊은</li>
		<li class='TrnTag'>평온한</li>
		<li class=\"active TrnTag\">생기있는</li>
		<li class='TrnTag'>감성적</li>
		<li class='TrnTag'>열정적</li>
		<li class='TrnTag'>재미있는</li>
	</ul>

	<div class=\"class_teacher_search\">
		<input type=\"text\" name=\"\" class=\"class_teacher_input TrnTag\" placeholder=\"검색어를 입력하세요.\">
		<a href=\"#\"><img src=\"".$ServerPath."images/btn_zoom_black.png\" alt=\"검색\" class=\"class_teacher_search_btn\"></a>
	</div>

	<h3 class=\"caption_left_common TrnTag\"><b>강사</b> 선택<span>*  강사선택 버튼을 클릭하시어 수강가능 시간을 확인하시고 수강신청 하시면 됩니다.</span></h3>
	...
	<ul class=\"teacher_select_list accordion-list\">
		...
		<li>
			<div class=\"teacher_photo_wrap\">
				...
				<a href=\"#\" class=\"teacher_select_btn accordion-item-toggle TrnTag\">강사선택</a>
			</div>
			<div class=\"teacher_time_wrap accordion-item-content\">
				<div class=\"teacher_time_caption TrnTag\"><img src=\"".$ServerPath."images/icon_time.png\">수강가능시간</div>
				<span class=\"teacher_time_line\"></span>
				<table class=\"teacher_time_table\">
					<tr>
						<th class='TrnTag'>월요일</th>
						<td>
					...
					<tr>
						<th class='TrnTag'>목요일</th>
						<td></td>
					</tr>
					<tr>
						<th class='TrnTag'>금요일</th>
						<td>
							<span class=\"teacher_time\">12:30</span>
							<span class=\"teacher_time\">14:30</span>
							<span class=\"teacher_time\">15:30</span>
				...
				<a href=\"#\" class=\"teacher_select_submit open-popup TrnTag\" data-popup=\".popup-class-payment\">수강신청하기</a>
			</div>
			<div class=\"teacher_profile_wrap\">
				<a href=\"#\" class=\"teacher_greeting_btn\"><trn class='TrnTag'>인사영상</trn> <img src=\"".$ServerPath."images/arrow_big_right.png\"></a>
		...
		<li>
			...
			<div class=\"teacher_time_wrap accordion-item-content\">
				<div class=\"teacher_time_caption\"><img src=\"".$ServerPath."images/icon_time.png\"><trn class='TrnTag'>수강가능시간</trn></div>
				<table class=\"teacher_time_table\">
					<tr>
						<th class='TrnTag'>월요일</th>
						<td>
