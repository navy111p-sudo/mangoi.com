...
if ($TotalCount==0){
	...
	$PageReportLeveltestListHTML .= "		<trn class='TrnTag'>망고아이 레벨테스트(샘플)</trn>";
	$PageReportLeveltestListHTML .= "		<div class=\"level_date\"><trn class='TrnTag'>평가일</trn> : 2019.09.28</div>";
	...
	$PageReportLeveltestListHTML .= "</li>";
		...
		while($Row = $Stmt->fetch()) {
			...
			$PageReportLeveltestListHTML .= "		<div class=\"level_date\"><trn class='TrnTag'>평가일</trn> : ".$AssmtStudentLeveltestScoreYear.".".substr("0".$AssmtStudentLeveltestScoreMonth,-2).".".substr("0".$AssmtStudentLeveltestScoreDay,-2)."</div>";
			$PageReportLeveltestListHTML .= "	</div>";
