...
$PageTeacherListBestHTML .= "<div class=\"teacher_rank_score TrnTag\">학생들의 평가점수로 선발</div>";
...
for ($ii=1;$ii<=10;$ii++) {
	...
	if ($TeacherListBestTeacherID[$ii]!=0){
		...
		$PageTeacherListBestHTML .= "<a href=\"#\" class=\"teacher_btn_orange TrnTag\" onclick=\"OpenTeacherVideo('".$TeacherVideoType."','".$TeacherVideoCode."')\">인사영상</a>";
