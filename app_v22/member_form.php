...
$_MEMBER_LOGIN_ID_ = $MemberLoginID;
?>
	<!-- 헤더 영역 -->
            ...
            <div class="page no-toolbar" data-page="intro_mypage">
                <div class="page-content navbar-fix">
					<section class="member_area">
						<h3 class="member_join_caption TrnTag">회원정보<span><b class="member_red">★</b> 표시는 필수 입력사항입니다.</span></h3>
						...
						<table class="member_table">
							...
							?>
							<tr id="MemberIDForm2">
								<th class="TrnTag">아이디 <b class="member_red">★</b></th>
								<td>
									<!-- style 추가, a tag -->
									<input type="email" class="member_id" name="MemberLoginID" id="MemberLoginID" onkeyup="EnNewID()" style="ime-mode:disabled;"><a class="member_btn_confirm_1 TrnTag" href="javascript:CheckID()" id="BtnCheckID">중복확인</a>
							...
							<tr>
								<th class="TrnTag">비밀번호 <b class="member_red">★</b></th>
								<td class="Join1">
							...
							<tr>
								<th class="TrnTag">비밀번호 확인 <b class="member_red">★</b></th>
								<td class="Join1">
						...
						<table class="member_table">
							...
							<tr>
								...
								<td>
									...
									<a href="javascript:CheckEmail()" name="CheckedEmail" class="member_btn_confirm_2 TrnTag" id="BtnCheckID2" style="display:<?if ($MemberID=="") {?><?}else{?>none<?}?>" >중복확인</a>
									<div class="member_idpw_text check_wrap agree" style="display:none;"><input type="checkbox" id="MemberEmailAgree" class="input_check" value="1" <?if ($MemberEmailAgree==1) {?>checked<?}?> name="MemberEmailAgree"><label class="label TrnTag" for="MemberEmailAgree"><span class="bullet_check"></span>이메일 수신동의</label></div>
								</td>
							</tr>

							<tr style="display:none;">
								<th class="TrnTag">주소 <b class="member_red">★</b></th>
								<td>
