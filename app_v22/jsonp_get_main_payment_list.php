...
$MainPaymentListHTML = "";
$MainPaymentListHTML .= "<div style=\"margin-top:5px;margin-bottom:5px;line-height:1.5;\" class='TrnTag'>※ 종료일자는 정규 종료일자 입니다.<br>※ 연기/보강/변경 등은 종료일자 이후라도 수업이 진행됩니다.<br>※ 종료일자 미설정시 연장이 불가합니다.(문의요망)</div>";
...
$MainPaymentListHTML .= "		<th class='TrnTag'>신청일</th>";
$MainPaymentListHTML .= "		<th class='TrnTag'>시작일</th>";
$MainPaymentListHTML .= "		<th class='TrnTag' rowspan=\"2\">상태</th>";
$MainPaymentListHTML .= "		<th class='TrnTag' rowspan=\"2\">수강연장</th>";
$MainPaymentListHTML .= "	</tr>";
$MainPaymentListHTML .= "	<tr>";
$MainPaymentListHTML .= "		<th class='TrnTag'>수강명</th>";
$MainPaymentListHTML .= "		<th class='TrnTag'>종료일</th>";
$MainPaymentListHTML .= "	</tr>";
...
while($Row = $Stmt->fetch()) {
	...
	$MainPaymentListHTML .= "		<td rowspan=\"2\" style=\"line-height:1.5;\" class='TrnTag'>".str_replace("-",".",$StrClassOrderState)."</td>";
		...
		//}else{
			if ($CenterPayType==2){//1: B2B 결제, 2:B2C 결제
				if ($StrStudyAuthDate=="" || $StrStudyAuthDate=="0000-00-00"){
					$MainPaymentListHTML .= "		<td class='TrnTag' rowspan=\"2\">종료일미설정</td>";
				}else{
					$MainPaymentListHTML .= "		<td class='TrnTag' rowspan=\"2\" onclick=\"PayPreAction(".$ClassOrderID.")\">연장하기</td>";
				}
			}else{
				if ($MemberPayType==1){//1:개인결제 - B2B 학원결제일 경우 일겨우만 사용
					...
					$MainPaymentListHTML .= "		<td class='TrnTag' rowspan=\"2\" onclick=\"PayPreActionErr(".$ClassOrderID.")\">연장하기</td>";
				}
			}
		//}
...
if ($ii==1){
	$MainPaymentListHTML .= "	<tr>";
	$MainPaymentListHTML .= "		<td class='TrnTag' colspan='4'>수강신청 내역이 없습니다</td>";
	$MainPaymentListHTML .= "	</tr>";
}
...
$MainPaymentListHTML .= "	<col width=\"21%\">";
$MainPaymentListHTML .= "	<tr>";
$MainPaymentListHTML .= "		<th class='TrnTag'>구매일자1</th>";
$MainPaymentListHTML .= "		<th class='TrnTag'>금액</th>";
$MainPaymentListHTML .= "		<th class='TrnTag' rowspan=\"2\">구매상태</th>";
$MainPaymentListHTML .= "		<th class='TrnTag' rowspan=\"2\">결제수단</th>";
$MainPaymentListHTML .= "	</tr>";
$MainPaymentListHTML .= "	<tr>";
$MainPaymentListHTML .= "		<th class='TrnTag'>이용권명</th>";
$MainPaymentListHTML .= "		<th class='TrnTag'>수량</th>";
$MainPaymentListHTML .= "	</tr>";
...
while($Row = $Stmt->fetch()) {
	...
	$MainPaymentListHTML .= "		<td class='TrnTag' rowspan=\"2\">".$StrClassOrderPayProgress."</td>";
	$MainPaymentListHTML .= "		<td class='TrnTag' rowspan=\"2\">".$StrClassOrderPayUseCashPaymentType."</td>";
	$MainPaymentListHTML .= "	</tr>";
	$MainPaymentListHTML .= "	<tr>";
	$MainPaymentListHTML .= "		<td class='TrnTag'>망고아이 수강등록</td>";
	$MainPaymentListHTML .= "		<td>-</td>";
	$MainPaymentListHTML .= "	</tr>";
...
if ($ii==1){
	$MainPaymentListHTML .= "	<tr>";
	$MainPaymentListHTML .= "		<td class='TrnTag' colspan='4'>결제내역이 없습니다</td>";
	$MainPaymentListHTML .= "	</tr>";
}
