...
$MainMyPointRank .= "	<li>";
$MainMyPointRank .= "		<div class=\"main_my_point_caption TrnTag\">나의 포인트</div>";
$MainMyPointRank .= "		<b class=\"main_my_point_num color_sea\">".$TotalMemberPoint." P</b>";
$MainMyPointRank .= "	</li>";
$MainMyPointRank .= "	<li>";
$MainMyPointRank .= "		<div class=\"main_my_point_caption TrnTag\">주간 순위</div>";
$MainMyPointRank .= "		<b class=\"main_my_point_num color_pink\">".$MyRank1."위</b>";
$MainMyPointRank .= "	</li>";
$MainMyPointRank .= "	<li>";
$MainMyPointRank .= "		<div class=\"main_my_point_caption TrnTag\">월간 순위</div>";
$MainMyPointRank .= "		<b class=\"main_my_point_num color_pink\">".$MyRank2."위</b>";
$MainMyPointRank .= "	</li>";
$MainMyPointRank .= "	<li>";
$MainMyPointRank .= "		<div class=\"main_my_point_caption TrnTag\">전체 순위</div>";
