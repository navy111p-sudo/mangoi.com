...
if ($ExistPopup==1) {
	...
	$PopupHTML .= "		<input type=\"checkbox\" name=\"pop_msg_close\" id=\"pop_msg_close\"> <label for=\"pop_msg_close\" class='TrnTag'><span></span> 오늘 하루 그만 보기</label>";
	$PopupHTML .= "		<a class=\"btn_pop_close TrnTag\" onclick=\"PopupMsgClose();\">닫기</a>";
	$PopupHTML .= "	</div>";
	$PopupHTML .= "</div>";
