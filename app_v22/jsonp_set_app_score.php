...
$AppScore = isset($_REQUEST["AppScore"]) ? $_REQUEST["AppScore"] : "";
...
$Sql = "
	insert into AppScores ( ";
$Sql .= " MemberID, ";
$Sql .= " AppScore, ";
$Sql .= " DeviceType, ";
$Sql .= " AppScoreRegDateTime, ";
$Sql .= " AppScoreModiDateTime, ";
$Sql .= " AppScoreState ";
$Sql .= " ) values ( ";
$Sql .= " :MemberID, ";
$Sql .= " :AppScore, ";
...
$Stmt->bindParam(':AppScore', $AppScore);
