...
if(jQuery) (function($) {
  ...
  function show(type, message, options) {
	...
	if (typeof(obj_lang_alert)!=='undefined'){

		//다국어 관련
		TrnAppAlertMsg = message;
		if (obj_lang_alert!=null && obj_lang_alert!=""){
			if (TrnTranslationMode==1 && TrnRun){
				if (obj_lang_alert[message]!=null && obj_lang_alert[message]!=""){
					TrnAppAlertMsg = obj_lang_alert[message];
				}
				
			}
		}
		message = TrnAppAlertMsg;
		//다국어 관련
